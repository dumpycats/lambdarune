...
if (global.finaltalk)
{
    ...
    if (finaltalktimerdelta >= 443 && finaltalktimerdelta <= 459)
    {
        if (!finallaugh)
        {
            window_set_caption("EX-STATIC RESONANCE");
...
if (progressfinal)
{
    ...
    if (enemydialogue > 31)
    {
        ...
        {
            case 0:
                tennatext = "Please try againagainagainagain";
                break;
            case 1:
                tennatext = "Can you hear the choir bells toll?";
                break;
            case 2:
                tennatext = "I won't give up@ Not anymore.";
                break;
            case 3:
                tennatext = "Will you abandon me tootootootootootoo?";
                break;
            case 4:
                tennatext = "Change is coming to this world!";
                break;
        }
    }
    ...
    if (jammed)
    {
        jamtext = "TECHNICAL DIFFICULTIES. PLEASE STAND BY.";
    ...
    {
        jamtext = "(bzzt) WARNING@ Light rain ahead! (bzzt)";
    }
    else if (global.turn == 10)
    {
        jamtext = "(bzzt) WARNING@ Stormy weather ahead! (bzzt)";
    }
    else if (global.turn == 11)
    {
        jamtext = "(bzzt) Here comes the sun... (bzzt)";
    }
    else if (jamphase == 0)
    {
        randomize();
        ...
        {
            case 0:
                jamtext = "(bzzt) Will this hurt} Stay tuned to find out! (bzzt)";
                break;
            case 1:
                jamtext = "(bzzt) Forecast calls for a nice spray of bullets! (bzzt)";
                break;
            case 2:
                jamtext = "(stock laughter)";
                break;
        }
    }
    else if (jamphase == 1)
    {
        ...
        {
            case 0:
                jamtext = "(bzzt) This one will definitely lose us some advertisers. (bzzt)";
                break;
            case 1:
                jamtext = "(bzzt) Viewer polls say I'm not hitting you hard enough. (bzzt)";
                break;
            case 2:
                jamtext = "(bzzt) This next attack goes out to all my critics. (bzzt)";
                break;
        }
    }
    else if (jamphase == 2)
    {
        ...
        {
            case 0:
                jamtext = "(bzzt) I don't know about this anymore... (bzzt)";
                break;
            case 1:
                jamtext = "(bzzt) Is it... even worth it? (bzzt)";
                break;
            case 2:
                jamtext = "(bzzt) I wish she was still here... (bzzt)";
                break;
        }
    }
    else if (jamphase >= 3)
    ...
    else if (krisselected)
    {
        ...
        if (krismenuoptions == 1 || krismenuoptions == 2 || krismenuoptions == 4)
        {
            if (!krisactselected)
            {
                ...
                draw_text_transformed(cx + 424, cy + 366, "HP", 1, 0.5, 0);
                draw_text_transformed(cx + 524, cy + 366, "MERCY", 1, 0.5, 0);
            ...
            if (krismenuoptions == 2)
            {
                ...
                else if (krisactselected)
                {
                    ...
                    draw_text(cx + 30, cy + 379, "Check");
                    
                    if (krisactoptions == 1)
                    {
                        draw_text_color(cx + 500, cy + 379, "Seek\nTruth", c_gray, c_gray, c_gray, c_gray, 1);
                        draw_text_color(cx + 500, cy + 379, "\n\n" + string(global.harmonytp) + "%   TP", tpcolor, tpcolor, tpcolor, tpcolor, 1);
                    }
                    
                    if (!jammed)
                    {
                        if (!krisdown && !susiedown && !ralseidown && global.tp >= global.harmonytp)
                            draw_text(cx + 260, cy + 379, "                              Harmonize");
                        else
                            draw_text_color(cx + 260, cy + 379, "                              Harmonize", c_gray, c_gray, c_gray, c_gray, 1);
                    }
                    else
                    {
                        draw_text_color(cx + 260, cy + 379, "                              JAMMED", c_red, c_red, c_red, c_red, 1);
                    }
        ...
        if (krismenuoptions == 3 && !(advancecounter >= 12))
        {
            ...
            else if (healmenu)
            {
                ...
                draw_set_font(fDeterminationSans);
                draw_text_with_tracking(cx + 80, cy + 379, "Kris\nSusie\nRalsei", 16777215, 0, -2);
...
if (susiemenuaccessible)
{
    ...
    else if (susieselected)
    {
        ...
        if (susiemenuoptions == 2)
        {
            ...
            {
                if (global.tp < 50)
                    draw_text_color(cx + 30, cy + 379, "Rude   Buster", c_gray, c_gray, c_gray, c_gray, 1);
                else
                    draw_text(cx + 30, cy + 379, "Rude   Buster");
                
                if (global.tp < 84)
                    draw_text_color(cx + 260, cy + 379, "BadassHeal", c_gray, c_gray, c_gray, c_gray, 1);
                else
                    draw_text(cx + 260, cy + 379, "BadassHeal");
                
                if (susieactoptions == 0)
                {
                    draw_sprite_ext(spr_SOUL_battle, 0, cx + 18, cy + 393, 1, 1, 0, c_red, 1);
                    draw_text_color(cx + 500, cy + 379, "Rude\nDamage", c_gray, c_gray, c_gray, c_gray, 1);
                    draw_text_color(cx + 500, cy + 379, "\n\n50%   TP", tpcolor, tpcolor, tpcolor, tpcolor, 1);
                }
                else if (susieactoptions == 1)
                {
                    draw_sprite_ext(spr_SOUL_battle, 0, cx + 238, cy + 393, 1, 1, 0, c_red, 1);
                    draw_text_color(cx + 500, cy + 379, "Badass\nHealing", c_gray, c_gray, c_gray, c_gray, 1);
                    draw_text_color(cx + 500, cy + 379, "\n\n84%   TP", tpcolor, tpcolor, tpcolor, tpcolor, 1);
                }
        ...
        if (ralseimenuoptions == 1 || ralseimenuoptions == 2 || ralseimenuoptions == 4)
        {
            ...
            if (ralseimenuoptions == 2)
            {
                ...
                else if (ralseiactselected)
                {
                    ...
                    {
                        if (global.tp < 16)
                            draw_text_color(cx + 30, cy + 379, "Pacify", c_gray, c_gray, c_gray, c_gray, 1);
                        else
                            draw_text(cx + 30, cy + 379, "Pacify");
                        
                        if (global.tp < 32)
                            draw_text_color(cx + 260, cy + 379, "Heal   Prayer", c_gray, c_gray, c_gray, c_gray, 1);
                        else
                            draw_text(cx + 260, cy + 379, "Heal   Prayer");
                        
                        if (ralseiactoptions == 0)
                        {
                            draw_text_color(cx + 500, cy + 379, "Spare\nTIRED   Foe", c_gray, c_gray, c_gray, c_gray, 1);
                            draw_text_color(cx + 500, cy + 379, "\n\n16%   TP", tpcolor, tpcolor, tpcolor, tpcolor, 1);
                        }
                        else
                        {
                            draw_text_color(cx + 500, cy + 379, "Heal\nAlly", c_gray, c_gray, c_gray, c_gray, 1);
                            draw_text_color(cx + 500, cy + 379, "\n\n32%   TP", tpcolor, tpcolor, tpcolor, tpcolor, 1);
                        }
...
if (textmenu)
{
    ...
    switch (menudialogue)
    {
        case 1:
            ...
            if (finalrequirement)
            {
                current_dialogue = format_text("Something resonates within Foane... the sleeping static awakens!", 31);
            }
            else if (global.turn == 1)
            {
                current_dialogue = format_text("The strongest Darkner you've ever met is before you.", 31);
            }
            else
            {
                susietalk = false;
                ...
                {
                    case 1:
                        current_dialogue = format_text("You can hear the audience of a show long gone.", 31);
                        break;
                    case 2:
                        current_dialogue = format_text("The air resonates with freedom.", 31);
                        break;
                    case 3:
                        current_dialogue = format_text("The puppeteer is pulling the strings!", 31);
                        break;
                    case 4:
                        current_dialogue = format_text("Unanswered prayers fill your head.", 31);
                        break;
                    case 5:
                        current_dialogue = format_text("Foane laughs at a joke in her head.", 31);
                        break;
                    case 6:
                        current_dialogue = format_text("Smells like burning copper.", 31);
                        break;
                    case 7:
                        current_dialogue = format_text("A forgotten melody echoes from Foane's soul.", 31);
                        break;
                    case 8:
                        current_dialogue = format_text("The Broadcast World trembles above.", 31);
                        break;
                    case 9:
                        current_dialogue = format_text("Unanswered prayers fill your head.", 31);
                        break;
...
if (textenemy)
{
    ...
    switch (enemydialogue)
    {
        case 1:
            ...
            current_dialogue = format_text_battle("I've heard the signals from outsidesidesidesideside", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 6;
            break;
        case 2:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("All those sad calls, wishing things were different...", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 0;
            break;
        case 3:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("I understand your hesitation, but why leave me on hold like thisthisthisthisthisthis?", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 7;
            break;
        case 4:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("You know what we're missing out on, dancing on these loathsome strings.", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 0;
            break;
        case 5:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Hahaha{ What adorable, foolish puppets we all make!", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 6:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("If I can't persuade you to stand down...", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 7:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Perhaps you'll listen to a familiar face?", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 8:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Tell memememememe", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 9:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("After overcoming mad clowns and filthy swindlers, do you really want to stop chasing that signal?", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 6;
            break;
        case 10:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Living unsatisfied, letting sweet nothings be whispered in your ear?", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 6;
            break;
        case 11:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("I know it can be hard to hear all this, but don't feel down!", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 0;
            break;
        case 12:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("When I felt sad, I liked to play my favorite songsongsongsongsongsong", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 6;
            break;
        case 13:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Look at how much BRIGHTER life becomes{ Take a slice...", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 0;
            break;
        case 14:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("In a world that leaves us in silence, I'll stand by you!", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 15:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("None of us have to be alone anymore!", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 16:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("You don't have to be a fool, staring at a fraudulent sky...", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 17:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("WATCHING YOUR BROKEN MIND MANIFEST AS A #$%!ING CATCATCATCATCATCAT", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 18:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("My oh my, aren't you popular these days, Kris!", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 6;
            break;
        case 19:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("So many incoming callers with things to tell youyouyouyouyouyou!", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 20:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("You know, I always thought I had a lot to say...", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 21:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("But when I heard the call, I realized my words were nothing but garbage.", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 22:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("I'll tell you what, speaking garbage isn't half as fun as lying around like it.", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 23:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Thinking about it makes my entire body buzz with disgust!", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 24:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Cities rise and fall, people enter and exit the stagestagestagestagestage", 17 + dialoguexoffset);
            typing_speed = 1;
            dialoguexoffset = 8;
            break;
        case 25:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("...But nothing will ever change.", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 26:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Nothing will ever matter... unless...", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case 27:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Unless... we ", 17 + dialoguexoffset);
            typing_speed = 1;
        ...
        case 28:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("           ", 17 + dialoguexoffset);
            typing_speed = 1;
            d29timer++;
        ...
        case 29:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("Um, one second...", 17 + dialoguexoffset);
            typing_speed = 1;
            blockprogress = false;
            break;
        case 30:
        ...
        case 31:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("They called the wrong number.", 17 + dialoguexoffset);
            typing_speed = 1;
            blockprogress = false;
        ...
        case -7:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("... Nothing will ever matter unless we turn our ears to heaven.", 17 + dialoguexoffset);
            typing_speed = 1;
            global.enemyturn = false;
            soulsubimg = -1;
            break;
        case -6:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("HAHAHA!", 17 + dialoguexoffset);
            typing_speed = 1;
        ...
        case -5:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("LOOK AT WHAT I HAVE ACCOMPLISHED IN JUST ONE DAYDAYDAYDAYDAYDAY", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case -4:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("NO ONE CAN BRING ME DOWN FROM THIS HIGH@ NOBODY CAN.", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case -3:
            tennatalk = true;
            dialoguebubblexscale = 1;
            current_dialogue = format_text_battle("IT'S DRAWING EVER CLOSER... CAN YOU HEAR IT?", 17 + dialoguexoffset);
            typing_speed = 1;
            break;
        case -2:
            tennatalk = true;
            ...
            if (songchoice == oldchoice && global.c3signalcompleted)
                current_dialogue = format_text_battle("THIS IS MY SIGNAL OF FREEDOM!", 17 + dialoguexoffset);
            else
                current_dialogue = format_text_battle("THE EX-STATIC RESONANCE IS UPON US!!", 17 + dialoguexoffset);
...
if (textact)
{
    ...
    switch (actdialogue)
    {
        case 1:
            ...
            {
                current_dialogue = format_text("Harmonious Foane - Pulls the strings and makes them ring.", 31);
            }
            else if (krismercy || susiemercy || ralseimercy)
            {
                current_dialogue = format_text(string(ACTNAME) + " spared Foane EX{\n* But its name wasn't YELLOW...", 60);
            }
            ...
            {
                current_dialogue = format_text("Everyone harmonized with Foane{ Her attack changes...", 31);
            }
