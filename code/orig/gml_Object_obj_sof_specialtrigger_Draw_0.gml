...
draw_text(cx + 318, cy + 50, "Press R to RESTART\nPress N to NO HIT");
draw_text(cx + 322, cy + 50, "Press R to RESTART\nPress N to NO HIT");
draw_text(cx + 320, cy + 48, "Press R to RESTART\nPress N to NO HIT");
draw_text(cx + 320, cy + 52, "Press R to RESTART\nPress N to NO HIT");
draw_set_color(c_white);
draw_text(cx + 320, cy + 50, "Press R to RESTART\nPress N to NO HIT");
