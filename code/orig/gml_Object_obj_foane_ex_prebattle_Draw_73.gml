...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            current_dialogue = format_text("... That flower lady...", 31);
            typing_speed = 1;
            break;
        case 2:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("No matter@ It'll take more than some mantle to stop me.", 31);
            typing_speed = 1;
            break;
        case 3:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I'm so close now... I can feel it.", 31);
            typing_speed = 1;
            break;
        case 4:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("A resonance, threading through the clouds, piercing the earth...", 31);
            typing_speed = 1;
            break;
        case 5:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("A harmony from heaven.", 31);
            typing_speed = 1;
            break;
        case 6:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("And soon...", 31);
            typing_speed = 1;
            break;
        case 7:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("It will be mine to taketaketaketaketaketake!", 31);
            typing_speed = 1;
    ...
    if (dialogue == 7)
    {
        var text_parts = string_split(current_dialogue, "take");
        var x_offset = text_x;
        var y_offset = text_y;
