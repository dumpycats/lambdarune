if (instance_exists(obj_damage))
{
    ...
    for (var i = 1; i <= string_length(value); i++)
    {
        ...
        {
            draw_sprite_ext(spr_down_text, 0, text_x, text_y, image_xscale, image_yscale, 0, c_red, image_alpha);
        }
        else if (up)
        {
            draw_sprite_ext(spr_up_text, 0, text_x, text_y, image_xscale, image_yscale, 0, c_lime, image_alpha);
        }
    }
}
