...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("\"Don't forget@\"", 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text("\"Even though pale dunes erode the earth where hills once rolled green@\"", 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text("\"Even though the towers that once reached the stars are now rubble@\"", 31);
            typing_speed = 1;
            break;
        case 4:
            texttalk = true;
            current_dialogue = format_text("\"History may erase us, but it will never erase@@@\"", 31);
            typing_speed = 1;
            break;
        case 5:
            texttalk = true;
            current_dialogue = format_text("\"Our promise, the enduring dream of what will return@\"", 31);
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
        ...
        case 7:
            texttalk = true;
            current_dialogue = format_text("(The rest of the writing is garbage@)", 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
