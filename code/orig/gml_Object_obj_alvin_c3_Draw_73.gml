...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("Are you sure about this?", 31);
            typing_speed = 2/3;
            break;
        case 2:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("Are you truly sure?", 31);
            typing_speed = 2/3;
        ...
        case 4:
            texttalk = false;
            cloaktalk = true;
            current_dialogue = format_text("It's the only way to get what we both want.", 31);
            typing_speed = 2/3;
        ...
        case 5:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(...This strange fellow... I can tell they're bad news.)", 31);
            typing_speed = 2/3;
        ...
        case 6:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(A well-adjusted individual wouldn't lurk around in a cloak.)", 31);
            typing_speed = 2/3;
            break;
        case 7:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(Still, something's... off@ Doing what they want is dangerous...)", 31);
            typing_speed = 2/3;
            break;
        case 8:
            texttalk = false;
            cloaktalk = true;
            current_dialogue = format_text("This is the right path@ You want answers, don't you?", 31);
            typing_speed = 2/3;
            break;
        case 9:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(Despite myself, I feel as if I have no choice.)", 31);
            typing_speed = 2/3;
            image_index = 1;
            break;
        case 10:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(Father's incomplete research, the strange darkness, this cloaked Knight before me...)", 31);
            typing_speed = 2/3;
            break;
        case 11:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(It's all connected.)", 31);
            typing_speed = 2/3;
            break;
        case 12:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("(I need to know what my father was searching for.)", 31);
            typing_speed = 2/3;
            break;
        case 13:
            texttalk = true;
        ...
        case 14:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("I'll get the hammer.", 31);
            typing_speed = 2/3;
            break;
        case 15:
            texttalk = true;
            cloaktalk = false;
            current_dialogue = format_text("...What?", 31);
            typing_speed = 2/3;
            sprite_index = spr_alvin_down;
        ...
        case 16:
            ...
            current_dialogue = format_text("...\"We're being watched\"...?", 31);
            typing_speed = 0.5;
            window_set_caption("");
            break;
        default:
