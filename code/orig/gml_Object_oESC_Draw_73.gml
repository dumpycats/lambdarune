...
if (debugfps)
{
    ...
    var fpscounter = "FPS: " + string(round(fps_real));
...
if (crttrigger)
{
    ...
    {
        var warning = "WARNING. HIGH VOLTAGE!\n(Press T to power on, V to exit.)";
    ...
    {
        var warning = "WARNING. UNPLUG TV?\n(Press T to power off, V to exit.)";
        draw_text(cx + 320, cy + 48 + 2, warning);
        draw_text(cx + 320, (cy + 48) - 2, warning);
        draw_text(cx + 320 + 2, cy + 48, warning);
        draw_text((cx + 320) - 2, cy + 48, warning);
