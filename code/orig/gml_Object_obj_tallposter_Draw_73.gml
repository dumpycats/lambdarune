...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("Well, there is a poster here.", 31);
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = format_text("\"Have you seen this man{ Help on the way{ Can't help{ Call now!\"", 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text("The rest seems to be incoherent.", 31);
            typing_speed = 1;
            break;
        case 4:
            texttalk = true;
            current_dialogue = format_text("It's a wall.", 31);
            typing_speed = 1;
            break;
        case 5:
            texttalk = true;
