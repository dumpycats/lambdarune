...
switch (global.dialogue)
{
    case 1:
        ...
        if (!global.missedopportunity)
            global.current_dialogue = "* in the meantime...";
        else
    ...
    case 2:
        ...
        global.charactertalking = false;
        global.current_dialogue = "* (The Cell Phone was updated@)";
        global.typing_speed = 1;
        obj_foane_spacechannel.image_index = 2;
        d2timer++;
    ...
    case 4:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = "* WHAT WAS THAT FOR, MEW?!";
        global.typing_speed = 1;
    ...
    case 5:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = "* we're leaving, furball.";
        global.typing_speed = 1;
        audio_sound_pitch(snd_foane, 1);
        obj_foane_spacechannel.image_index = 0;
        obj_foane_spacechannel.image_speed = 0;
    ...
    case 6:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = "* BUT KRIS JUST GOT HERE!";
        global.typing_speed = 1;
    ...
    case 7:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = "* then say\n  goodbyebyebyebyebyebye";
        global.typing_speed = 1;
        obj_foane_spacechannel.image_index = 0;
        obj_foane_spacechannel.image_speed = 0;
        break;
    case 8:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = "* AWWWW... BYE, KRIS!";
        global.typing_speed = 1;
