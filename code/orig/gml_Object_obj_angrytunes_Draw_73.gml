...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = "* Grrr... They're refusing to\n  let me on the plane} Why, you\n  ask?";
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = "* Because my arms are \"too big!\"\n  And they won't let me take\n  multiple seats!";
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = "* Grrrrr... It's making me so...\n  SO...! ANGRY!!! I need to PUNCH\n  something!";
            typing_speed = 1;
            break;
        case 4:
            texttalk = true;
            current_dialogue = "* ...Don't worry, I'm not gonna\n  punch YOU@ You're cool.";
            typing_speed = 1;
            break;
        case 5:
            texttalk = true;
            current_dialogue = "* Who can I take my RAGE out\n  on...? Maybe this guy standing\n  next to me?";
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
            current_dialogue = "* Yeah, he's pretty loud and\n  obnoxious. I'm sure no one will\n  mind!";
            typing_speed = 1;
            break;
        case 7:
            texttalk = true;
