...
if (debug)
{
    ...
    if (generator1)
    {
        draw_text_ext_transformed(cx + 320, cy + 20, "GENERATOR 1 ON", 0, 640, 1, 1, 0);
        draw_text_ext_transformed(cx + 320, cy + 60, string(jamphase), 0, 640, 1, 1, 0);
    }
    
    if (generator2)
    {
        draw_text_ext_transformed(cx + 320, cy + 40, "GENERATOR 2 ON", 0, 640, 1, 1, 0);
        draw_text_ext_transformed(cx + 320, cy + 60, string(jamphase), 0, 640, 1, 1, 0);
    }
...
if (progressfinal)
{
    ...
    if (enemydialogue >= 62)
    {
        ...
        {
            case 0:
                tennatext = "I see right through you.";
                break;
            case 1:
                tennatext = "*sigh* Nobody appreciates surveillance states anymore.";
                break;
            case 2:
                tennatext = "Can I just... pay you to lose?";
                break;
            case 3:
                tennatext = "Stay away from my family.";
                break;
            case 4:
                tennatext = "I'm the REAL head of this household.";
                break;
            case 5:
                tennatext = "I'm not... *yawn* I'm not falling asleep this time.";
                break;
            case 6:
                tennatext = "You're pushing the runtime too far.";
                break;
            case 7:
                tennatext = "At least we're getting more ad space...";
                break;
        }
    }
        ...
        if (krismenuoptions == 1 || krismenuoptions == 2 || krismenuoptions == 4)
        {
            ...
            if (krismenuoptions == 2)
            {
                ...
                else if (krisactselected)
                {
                    ...
                    {
                        if (!krisdown && !susiedown && !ralseidown)
                            draw_text(cx + 260, cy + 379, "                              ChangeChannel");
                        else
                            draw_text_color(cx + 260, cy + 379, "                              ChangeChannel", c_gray, c_gray, c_gray, c_gray, 1);
                    }
                    else
                    {
...
if (susiemenuaccessible)
{
    ...
    else if (susieselected)
    {
        ...
        if (susiemenuoptions == 2)
        {
            ...
            {
                if (global.tp < 50)
                    draw_text_color(cx + 260, cy + 379, "Rude   Buster", c_gray, c_gray, c_gray, c_gray, 1);
                else
                    draw_text(cx + 260, cy + 379, "Rude   Buster");
                
                if (global.tp < 84)
                    draw_text_color(cx + 30, cy + 379, "\nBadassHeal", c_gray, c_gray, c_gray, c_gray, 1);
                else
                    draw_text(cx + 30, cy + 379, "\nBadassHeal");
                
                var saction = 16744703;
                
                if (!jammed)
                    draw_text_color(cx + 30, cy + 379, "S-Action", saction, saction, saction, saction, 1);
                else
                    draw_text_color(cx + 30, cy + 379, "JAMMED", c_red, c_red, c_red, c_red, 1);
            ...
            if (susieactselected && (susieactoptions == 1 || (susieactoptions == 0 && susieactoptionsvertical == 0)))
            {
                ...
                {
                    draw_text(cx + 80, cy + 379, "GENERATORS");
                }
                else
                {
                    draw_text(cx + 80, cy + 379, ENEMYNAME);
            ...
            if (ralseimenuoptions == 2)
            {
                ...
                else if (ralseiactselected)
                {
                    ...
                    if (!healmenu && !ralseimagicselected)
                    {
                        ...
                        if (!jammed)
                            draw_text_color(cx + 30, cy + 379, "R-Action", raction, raction, raction, raction, 1);
                        else
                            draw_text_color(cx + 30, cy + 379, "JAMMED", c_red, c_red, c_red, c_red, 1);
                        
                        if (global.tp < 16)
                            draw_text_color(cx + 260, cy + 379, "Pacify", c_gray, c_gray, c_gray, c_gray, 1);
                        else
                            draw_text(cx + 260, cy + 379, "Pacify");
                        
                        if (global.tp < 32)
                            draw_text_color(cx + 30, cy + 379, "\nHeal   Prayer", c_gray, c_gray, c_gray, c_gray, 1);
                        else
                            draw_text(cx + 30, cy + 379, "\nHeal   Prayer");
