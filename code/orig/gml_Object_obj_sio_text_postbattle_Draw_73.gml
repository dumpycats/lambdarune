...
if (talking)
{
    ...
    switch (dialogue)
    {
        ...
        case 2:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("Okay, look.", 25);
            typing_speed = 1;
            break;
        case 3:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("My goal was to fry your brains.", 25);
            typing_speed = 1;
            break;
        case 4:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("You know, so you would stop messing with my system and stuff.", 25);
            typing_speed = 1;
            break;
        case 5:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("But seeing as you still have functioning brains...", 25);
            typing_speed = 1;
            break;
        case 6:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("And my \"Lethal Attacks\" film reel is running out...", 25);
            typing_speed = 1;
            break;
        case 7:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("Can we just call it quits here? Come to an agreement?", 25);
            typing_speed = 1;
            break;
        case 8:
            ralseitalk = true;
            ...
            dialogueicon = 20;
            current_dialogue = format_text("You're finally willing to hear us out...?", 25);
            typing_speed = 1;
            break;
        case 9:
            ralseitalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("...No.", 25);
            typing_speed = 1;
            break;
        case 10:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 7;
            current_dialogue = format_text("I want you to unconditionally surrender.", 25);
            typing_speed = 1;
            break;
        case 11:
            susietalk = true;
            ...
            dialogueicon = 4;
            current_dialogue = format_text("Yeah... pass.", 25);
            typing_speed = 1;
            break;
        case 12:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Fine, if you won't negotiate...", 25);
            typing_speed = 1;
            break;
        case 13:
            texttalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("MAXIMIKE'S HP AND DEFENSE MAXED OUT!", 31);
            typing_speed = 1;
            d13timer++;
            
            if (d13timer == 0)
            {
                window_set_caption("Recharging");
        ...
        case 14:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("I guess I'll just redo all those attacks.", 25);
            typing_speed = 1;
            break;
        case 15:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("Again.", 25);
            typing_speed = 1;
            break;
        case 16:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("And again.", 25);
            typing_speed = 1;
            break;
        case 17:
            susietalk = false;
        ...
        case 18:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("I don't care what it takes to wear you down...", 25);
            typing_speed = 1;
            break;
        case 19:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("You will NOT close this fountain.", 25);
            typing_speed = 1;
            break;
        case 20:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("TAKE 2!!", 25);
            typing_speed = 1;
        ...
        case 22:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("I said...", 25);
            typing_speed = 1;
            break;
        case 23:
            miketalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Sorry to rain on your parade, Sis...", 31);
            typing_speed = 1;
            charactertalking = false;
        ...
        case 24:
            ...
            dialogueicon = 3;
            charactertalking = false;
            current_dialogue = format_text("But I'm afraid one will have to do!", 31);
            typing_speed = 1;
            break;
        case 25:
            miketalk = false;
            ...
            dialogueicon = 3;
            charactertalking = true;
            current_dialogue = format_text("Mike... cut it out.", 25);
            typing_speed = 1;
            break;
        case 26:
            miketalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Kris, Susie, thanks for waking me up.", 31);
            typing_speed = 1;
            break;
        case 27:
            miketalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("We've been doing this song and dance for too long... I'm calling it quits.", 31);
            typing_speed = 1;
            break;
        case 28:
            miketalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("THIS SHOW'S OVER!", 31);
            typing_speed = 1;
            break;
        case 29:
            miketalk = true;
            ...
            dialogueicon = 1;
            current_dialogue = format_text("GUESS WHO'S BACK!?", 25);
            typing_speed = 1;
            break;
        case 30:
            miketalk = false;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 6;
            current_dialogue = format_text("Is that it, then?", 25);
            typing_speed = 1;
            break;
        case 31:
            miketalk = false;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("We win?", 25);
            typing_speed = 1;
            break;
        case 32:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("...You're a fool, Mike...", 25);
            typing_speed = 1;
        ...
        case 33:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 6;
            current_dialogue = format_text("Sis...", 25);
            typing_speed = 1;
        ...
        case 34:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Why? Why won't you just listen?", 25);
            typing_speed = 1;
            break;
        case 35:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 8;
            current_dialogue = format_text("Why won't you trust me!?", 25);
            typing_speed = 1;
        ...
        case 36:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 10;
            current_dialogue = format_text("...I've always trusted you, Heinrike.", 25);
            typing_speed = 1;
        ...
        case 37:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 2;
            current_dialogue = format_text("Even when I didn't agree... even when it hurt to send her away...", 25);
            typing_speed = 1;
        ...
        case 38:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 7;
            current_dialogue = format_text("I stood by you.", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.image_index = 1;
            break;
        case 39:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 12;
            current_dialogue = format_text("But when is enough enough?", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.image_index = 2;
            break;
        case 40:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 12;
            current_dialogue = format_text("We haven't performed for Lightners in ages... our own people lost interest.", 26);
            typing_speed = 1;
        ...
        case 41:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 2;
            current_dialogue = format_text("We've done everything we can for this show@ It's... time to move on.", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.image_index = 6;
            break;
        case 42:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            current_dialogue = format_text("I can't imagine a world outside of my control.", 25);
            typing_speed = 1;
        ...
        case 43:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 8;
            current_dialogue = format_text("If something bad happens, who will stop it?", 25);
            typing_speed = 1;
            break;
        case 44:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("You can't just expect everything to go your way, dude.", 25);
            typing_speed = 1;
        ...
        case 45:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("Things'll happen whether you like it or not.", 25);
            typing_speed = 1;
            break;
        case 46:
            susietalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("So what, you expect me to do nothing} Let everything rust away?", 25);
            typing_speed = 1;
            break;
        case 47:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 25;
            current_dialogue = format_text("Hell no!", 25);
            typing_speed = 1;
            break;
        case 48:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 12;
            current_dialogue = format_text("Just saying, stop trying to make everything go how you want it.", 25);
            typing_speed = 1;
            break;
        case 49:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 10;
            current_dialogue = format_text("Maybe... listen to someone else, for once.", 25);
            typing_speed = 1;
            break;
        case 50:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 13;
            current_dialogue = format_text("You've got a good brother@ You can figure things out together.", 25);
            typing_speed = 1;
            break;
        case 51:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("So forget the stupid TV show!", 25);
            typing_speed = 1;
            break;
        case 52:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("You won't be able to control everything, but when stuff happens...", 25);
            typing_speed = 1;
            break;
        case 53:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("There's plenty of folks who can help you make the best choice.", 25);
            typing_speed = 1;
            break;
        case 54:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("That's what friends are for@ Right, Ralsei?", 25);
            typing_speed = 1;
        ...
        case 55:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 13;
            current_dialogue = format_text("Huh?", 25);
            typing_speed = 1;
        ...
        case 56:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 17;
            current_dialogue = format_text("Y-Yeah, I guess so!", 25);
            typing_speed = 1;
            break;
        case 57:
            miketalk = true;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 5;
            current_dialogue = format_text("I trusted you, so please... trust me.", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.image_index = 0;
        ...
        case 58:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            current_dialogue = format_text("...Fine@ Do what you want.", 25);
            typing_speed = 1;
        ...
        case 59:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 0;
            current_dialogue = format_text("Hug it out?", 25);
            typing_speed = 1;
            break;
        case 60:
            tennatalk = true;
        ...
        case 61:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 26;
            current_dialogue = format_text("Thank you for understanding.", 25);
            typing_speed = 1;
            break;
        case 62:
            tennatalk = false;
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I promise your people will be safe and happy in Castle Town!", 25);
            typing_speed = 1;
            break;
        case 63:
            tennatalk = true;
        ...
        case 64:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("It's about time we wrap things up, shouldn't we...?", 25);
            typing_speed = 1;
            break;
        case 65:
            quip = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 5;
            current_dialogue = format_text("Guess this is goodbye for now, then.", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.image_index = 6;
            break;
        case 66:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 0;
            current_dialogue = format_text("SIS, ROLL CREDITS!", 25);
            typing_speed = 1;
        ...
        case 67:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Can we... not?", 25);
            typing_speed = 1;
        ...
        case 68:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 10;
            current_dialogue = format_text("Heh. You're no fun.", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.sprite_index = spr_mike_spin;
            obj_mike_sio_aftermath.image_index = 0;
        ...
        case 69:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("Sheesh@ Tenna couldn't even wait a few minutes before falling asleep.", 31);
            typing_speed = 1;
            obj_mike_sio_aftermath.sprite_index = spr_mike_spin;
            obj_mike_sio_aftermath.image_index = 2;
            break;
        case 70:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("...Guess we should talk about it, then@ Come closer.", 31);
            typing_speed = 1;
        ...
        case 72:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("I said I trusted you, didn't I?", 31);
            typing_speed = 1;
            break;
        case 73:
            tennatalk = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("Then do me a favor... and tell them you made the fountain.", 31);
            typing_speed = 1;
            break;
        case 74:
            tennatalk = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("It's bad to keep secrets from friends.", 31);
            typing_speed = 1;
            break;
        case 75:
            tennatalk = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("I don't know why you did it, but thank you.", 31);
            typing_speed = 1;
            break;
        case 76:
            tennatalk = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("After years of silence, we got to have one last show.", 31);
            typing_speed = 1;
            break;
        case 77:
            tennatalk = false;
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 3;
            current_dialogue = format_text("And you gotta admit, even if we nearly killed you a little...", 31);
            typing_speed = 1;
            break;
        case 78:
            tennatalk = false;
            ...
            charactertalking = true;
            dialogueicon = 1;
            current_dialogue = format_text("IT MADE FOR ONE HELL OF A FINALE!", 25);
            typing_speed = 1;
            mikeshake = true;
            obj_mike_sio_aftermath.sprite_index = spr_mike_happiest;
            obj_mike_sio_aftermath.image_index = 0;
        ...
        case 79:
            ...
            dialogueiconchoice = mikedialoguesprite;
            dialogueicon = 5;
            current_dialogue = format_text("I won't keep you anymore. Go get 'em, tiger!", 25);
            typing_speed = 1;
            obj_mike_sio_aftermath.sprite_index = spr_mike_spin;
