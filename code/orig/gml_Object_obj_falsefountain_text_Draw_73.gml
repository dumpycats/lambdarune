...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            susietalk = true;
            current_dialogue = format_text_battle("Here we go again.", 25);
            typing_speed = 1/3;
            break;
        case 2:
            susietalk = true;
            current_dialogue = format_text_battle("Ralsei's right, we have come a long way.", 25);
            typing_speed = 1/3;
            break;
        case 3:
            susietalk = true;
            current_dialogue = format_text_battle("I wonder how many more times we'll have to do this...", 25);
            typing_speed = 1/3;
            break;
        case 4:
            susietalk = true;
            current_dialogue = format_text_battle("It feels like every adventure gets bigger and bigger.", 25);
            typing_speed = 1/3;
            break;
        case 5:
            susietalk = true;
            current_dialogue = format_text_battle("I wonder... if it'll become too much for the three of us to handle?", 25);
            typing_speed = 1/3;
            obj_susie_c3.sprite_index = sSusieWalkRight;
            break;
        case 6:
            susietalk = true;
            current_dialogue = format_text_battle("...", 25);
            typing_speed = 1/3;
            obj_susie_c3.sprite_index = sSusieWalkDown;
            break;
        case 7:
            susietalk = true;
            current_dialogue = format_text_battle("Well, until then", 25);
            typing_speed = 1/3;
            obj_susie_c3.sprite_index = sSusieWalkLeft;
            break;
        case 8:
            susietalk = true;
            current_dialogue = format_text_battle("It's your move, Kris.", 25);
            typing_speed = 1/3;
            obj_susie_c3.sprite_index = sSusieWalkUp;
            break;
        case 9:
            susietalk = true;
            current_dialogue = format_text_battle("(It was as if your very SOUL was glowing...)", 25);
            typing_speed = 1/3;
            break;
        default:
            current_dialogue = "";
