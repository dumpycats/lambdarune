switch (global.cinematicdialogue)
{
    case 1:
        ...
        global.current_dialogue = "Desperation sparks extreme measures.";
        global.typing_speed = 0.5;
        break;
    case 2:
        global.charactertalking = true;
        global.current_dialogue = "But every action...";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    case 3:
        global.charactertalking = true;
        global.current_dialogue = "Carries consequences.";
    ...
    case 5:
        global.charactertalking = true;
        global.current_dialogue = "Yet, who will shoulder the burden?";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    case 6:
        global.charactertalking = true;
        global.current_dialogue = "Your friends?";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    case 7:
        global.charactertalking = true;
        global.current_dialogue = "You, perhaps?";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    case 8:
    ...
    case 9:
        global.charactertalking = true;
        global.current_dialogue = "In this dark labyrinth...";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    case 10:
        global.charactertalking = true;
        global.current_dialogue = "Choices echo eternity.";
        global.typing_speed = 0.5;
        global.shoptalkmenu = false;
        break;
    default:
