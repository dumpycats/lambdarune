...
window_set_caption("Signal of Freedom");
debug = false;
...
define_item(ITEM_KREID, "KRISPY KREID", "KKreid", "Heals\n140HP", 140, false);
define_item(ITEM_DONUT, "SHADOW DONUT", "SDonut", "Heals\n70HP", 70, false);
define_item(ITEM_MILK, "MIKE MILK", "MikeMilk", "Heals\nteam\n100HP", 100, true);
define_item(ITEM_STRUDEL, "STATIC STRUDEL", "SStrudel", "Heals\n90HP", 90, false);
define_item(ITEM_BTEA, "BUTTERCAN TEA", "ButtTea", "Heals\nteam\n???HP", 777, true);
define_item(ITEM_SPINCAKE, "SPINCAKE", "Spincake", "Heals\nteam\n140HP", 140, true);
define_item(ITEM_TEA, "...ROTTEN TEA", "RottenTea", "Heals\n10HP", 10, false);
define_item(ITEM_TV, "TV DINNER", "TVDinner", "Heals\n110HP", 110, false);
define_item(ITEM_REVIVE, "REVIVEMINT", "ReviveMint", "Heals\nDowned\nAlly", 999, false);
