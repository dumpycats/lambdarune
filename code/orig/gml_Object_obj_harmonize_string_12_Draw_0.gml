...
if (!(interacttimer >= 30 && right))
{
    ...
    var tex1 = sprite_get_texture(spr_harmonize_1, 10);
    var uvs1 = sprite_get_uvs(spr_harmonize_1, 10);
...
{
    draw_sprite_ext(spr_harmonize_1, 10, cx + 450, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_1, 10, cx + 450, cy + 116, 1, 1, 0, c_white, image_alpha);
}
else
{
    draw_sprite_ext(spr_harmonize_split_4, harmonysplit, cx + 450, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_split_4, harmonysplit, cx + 450, cy + 116, 1, 1, 0, c_white, image_alpha);
    harmonysplit += (2/3);
