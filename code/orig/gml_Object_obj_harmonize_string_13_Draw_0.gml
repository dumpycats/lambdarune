...
if (!(interacttimer >= 30 && right))
{
    ...
    var tex1 = sprite_get_texture(spr_harmonize_1, 14);
    var uvs1 = sprite_get_uvs(spr_harmonize_1, 14);
...
{
    draw_sprite_ext(spr_harmonize_1, 14, cx + 190, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_1, 14, cx + 190, cy + 116, 1, 1, 0, c_white, image_alpha);
}
else
{
    draw_sprite_ext(spr_harmonize_split_5, harmonysplit, cx + 190, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_split_5, harmonysplit, cx + 190, cy + 116, 1, 1, 0, c_white, image_alpha);
    harmonysplit += (2/3);
