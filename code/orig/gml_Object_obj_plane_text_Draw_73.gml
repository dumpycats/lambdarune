...
if (talking)
{
    ...
    switch (dialogue)
    {
        ...
        case 2:
            quip = false;
            current_dialogue = format_text("Does anyone else think something's... off?", 25);
            typing_speed = 1;
            dialogueicon = 5;
            break;
        case 3:
            ...
            current_dialogue = format_text("Now that you mention it...", 25);
            dialogueicon = 0;
            typing_speed = 1;
            break;
        case 4:
            current_dialogue = format_text("Yeah, it's weird.", 25);
            typing_speed = 1;
            dialogueicon = 10;
            break;
        case 5:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 20;
            current_dialogue = format_text("Isn't it} They're all", 25);
            typing_speed = 1;
        ...
        case 6:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("They haven't offered us free peanuts yet!", 25);
            dialogueicon = 7;
            typing_speed = 1;
            break;
        case 7:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 22;
            current_dialogue = format_text("...I was talking about the people reading newspapers.", 25);
            typing_speed = 1;
            break;
        case 8:
            susietalk = true;
        ...
        case 9:
            ...
            ralseitalk = false;
            texttalk = true;
            current_dialogue = format_text("Gig's up, boys!", 25);
            typing_speed = 1;
        ...
        case 10:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("(Not again!!)", 25);
            dialogueicon = 5;
            typing_speed = 1;
            break;
        case 11:
            ...
            current_dialogue = format_text("Howdy.", 25);
            dialogueicon = 11;
            typing_speed = 1;
            break;
        case 12:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text("Kreid!?", 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 13:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("Chairiel gave you some tips on avoiding Tenna's security, huh?", 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 14:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("Guess she forgot that she taught me all her tricks.", 25);
            dialogueicon = 8;
            typing_speed = 1;
            break;
        case 15:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("Any plan your tiny brains could try, I already thought of.", 25);
            dialogueicon = 13;
            typing_speed = 1;
            break;
        case 16:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("You came all the way up here for us?", 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 17:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("You must be really eager to lose again.", 25);
            dialogueicon = 2;
            typing_speed = 1;
            break;
        case 18:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("Cute, but I'm tired of playing with you two.", 25);
            dialogueicon = 9;
            typing_speed = 1;
        ...
        case 19:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 18;
            current_dialogue = format_text("HEY!!", 25);
            typing_speed = 1;
            blockprogress = true;
            d19timer++;
        ...
        case 20:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 30;
            current_dialogue = format_text("H-Hang in there, Kris!", 25);
            typing_speed = 1;
            blockprogress = true;
            d20timer++;
        ...
        case 21:
            ...
            current_dialogue = format_text("Have a nice flight!", 31);
            typing_speed = 1;
            blockprogress = false;
        ...
        case 22:
            ...
            ralseitalk = false;
            charactertalking = false;
            current_dialogue = format_text("(Actually, we should parachute out before Kreid wrecks the plane...!)", 31);
            typing_speed = 1;
            blockprogress = false;
        ...
        case 24:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("Well} Are you just gonna keep standing there?", 25);
            dialogueicon = 10;
            typing_speed = 1;
            break;
        case 25:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("All this time and you've still got nothing to say to me?", 25);
            dialogueicon = 9;
            typing_speed = 1;
        ...
        case 26:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("At least have the nerve to say you can't stand me{ Say it to my face!", 25);
            dialogueicon = 14;
            typing_speed = 1;
        ...
        case 27:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text("SAY SOMETHING!", 25);
            dialogueicon = 15;
            typing_speed = 1;
