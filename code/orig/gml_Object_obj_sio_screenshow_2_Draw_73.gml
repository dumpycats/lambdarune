...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("It's footage of Mike and Foane side by side.", 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text("\"M&F LIVE - Starring Mike & Foane T.\"", 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text("Despite everything, they're still smiling.", 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
