...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("The trail leads here.", 25);
            typing_speed = 1;
        ...
        case 3:
            texttalk = true;
            current_dialogue = format_text("This is exactly what I was afraid of.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            break;
        case 4:
            texttalk = false;
            susietalk = true;
            current_dialogue = format_text("If you know something about this, now would be a good time to share.", 25);
            typing_speed = 1;
        ...
        case 5:
            susietalk = false;
            texttalk = true;
            current_dialogue = format_text("Our predecessor, Loomi Neus, built this place.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            break;
        case 6:
            texttalk = true;
            current_dialogue = format_text("A vault in the depths of our world, situated at its very edge.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            break;
        case 7:
            texttalk = true;
            current_dialogue = format_text("It was built to pick up... signals.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            break;
        case 8:
            texttalk = false;
            ralseitalk = true;
            current_dialogue = format_text("What kind of signals...?", 25);
            typing_speed = 1;
        ...
        case 10:
            texttalk = true;
            current_dialogue = format_text("The kind no Darkner should ever hear.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            break;
        case 11:
            texttalk = true;
            current_dialogue = format_text("After Loomi's... crisis, and Foane listening to her words, I sealed it.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            break;
        case 12:
            texttalk = true;
            current_dialogue = format_text("Nobody else knew of this place's existence except for me.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            break;
        ...
        case 14:
            texttalk = true;
            current_dialogue = format_text("Please stop Foane@ She's tapping into forces beyond her control.", 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 6;
            break;
        ...
        case 16:
            ...
            texttalk = true;
            current_dialogue = format_text("Good luck in there.", 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 17:
            texttalk = true;
            current_dialogue = format_text("I'd help, but I swore to never come near this place again.", 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 18:
            texttalk = true;
            current_dialogue = format_text("And... this whole night has been tiring me out...", 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 19:
            texttalk = true;
            current_dialogue = format_text("So I think... I'll just...", 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            image_index = 1;
        ...
        case 20:
            texttalk = false;
            emptytalk = true;
            current_dialogue = format_text("Zzzzzz...", 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            image_index = 2;
