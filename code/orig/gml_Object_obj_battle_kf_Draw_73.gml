...
if (textmenu)
{
    ...
    switch (menudialogue)
    {
        case 1:
            ...
            if (global.turn == 1)
                current_dialogue = format_text("Time to face the truth.", 31);
            ...
            if (global.turn <= 7 && global.turn > 1)
            {
                ...
                {
                    case 1:
                        current_dialogue = format_text("Kreid's mantle shines in the moonlight.", 31);
                        break;
                    case 2:
                        current_dialogue = format_text("Kreid snaps their fingers to a tune in their head.", 31);
                        break;
                    case 3:
                        current_dialogue = format_text("Kreid is gritting their teeth.", 31);
                        break;
                    case 4:
                        current_dialogue = format_text("Time to face the truth.", 31);
                        break;
                    case 5:
                        current_dialogue = format_text("You nearly lose your footing@ Kreid tries not to laugh.", 31);
                        break;
                    case 6:
                        current_dialogue = format_text("Kreid's mantle shines in the moonlight.", 31);
                        break;
            ...
            if (global.turn == 8)
                current_dialogue = format_text("Shadows envelop your SOUL. Cross the strings to dodge attacks!", 31);
            ...
            if (global.turn >= 9 && global.turn < 15)
            {
                ...
                {
                    case 1:
                        current_dialogue = format_text("Kreid's mantle oozes with darkness.", 31);
                        break;
                    case 2:
                        current_dialogue = format_text("Kreid refuses to meet your gaze.", 31);
                        break;
                    case 3:
                        current_dialogue = format_text("Kreid is gritting their teeth.", 31);
                        break;
                    case 4:
                        current_dialogue = format_text("Smoke billows from under the plane.", 31);
                        break;
                    case 5:
                        current_dialogue = format_text("You nearly lose your footing@ Kreid doesn't react.", 31);
                        break;
                    case 6:
                        current_dialogue = format_text("You feel the plane vibrating under your feet...", 31);
                        break;
                    case 7:
                        current_dialogue = format_text("You feel the plane vibrating under your feet...", 31);
                        break;
            ...
            if (global.turn >= 15)
                current_dialogue = format_text("The plane enters a steep decline@ This is it.", 31);
...
if (textenemy)
{
    ...
    switch (enemydialogue)
    {
        case 1:
            ...
            texttalk = false;
            dialogueicon = 1;
            current_dialogue = format_text_battle("Do you have any idea what it was like?", 17);
            typing_speed = 1;
            break;
        case 2:
            kreidtalk = true;
            texttalk = false;
            dialogueicon = 1;
            current_dialogue = format_text_battle("What it was like... to be abandoned?", 17);
            typing_speed = 1;
            break;
        case 3:
            kreidtalk = true;
            texttalk = false;
            dialogueicon = 1;
            current_dialogue = format_text_battle("Wandering the dark, scared, confused...", 17);
            typing_speed = 1;
            break;
        case 4:
            kreidtalk = true;
            texttalk = false;
            dialogueicon = 1;
            current_dialogue = format_text_battle("Left with questions after questions...", 17);
            typing_speed = 1;
            break;
        case 5:
            current_dialogue = format_text_battle("\"Why would they abandon me} Did I do something wrong?\"", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 6:
            current_dialogue = format_text_battle("\"Am I... not good enough?\"", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 7:
            current_dialogue = format_text_battle("We were best friends@ You always looked up to me.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 8:
            current_dialogue = format_text_battle("So tell me why{ Don't you at least owe me that?", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 9:
            current_dialogue = format_text_battle("Can you even answer me, Kris?", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 10:
            current_dialogue = format_text_battle("Or... are you still trying to leave me in the dark?", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 11:
            current_dialogue = format_text_battle("I did EVERYTHING I could@ Everything I was supposed to.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 12:
            current_dialogue = format_text_battle("I worked tirelessly to be perfect, for YOU.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 13:
            current_dialogue = format_text_battle("I wanted to be the one who could lift you out of your dark place...", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 14:
            current_dialogue = format_text_battle("Someone who motivated you to keep persevering!", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 15:
            current_dialogue = format_text_battle("Funny how that works, huh?", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 16:
            current_dialogue = format_text_battle("I try to pull you out of the shadows, and you toss me into them?", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 17:
            current_dialogue = format_text_battle("Well, I found a home there.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 18:
            current_dialogue = format_text_battle("A home with people who won't put a knife in my back!", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 19:
            current_dialogue = format_text_battle("When you came back, all I could think about was finding you.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 20:
            current_dialogue = format_text_battle("Revenge was part of it, but that only goes so far.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 21:
            current_dialogue = format_text_battle("Really, I've just been dying to know where I went wrong.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 22:
            current_dialogue = format_text_battle("But if you can't, or won't give me answers...", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 23:
            current_dialogue = format_text_battle("Then there's no point in trying anymore.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        case 24:
            current_dialogue = format_text_battle("Goodbye, Kris.", 17);
            kreidtalk = true;
            texttalk = false;
            break;
        default:
...
if (textact)
{
    ...
    switch (actdialogue)
    {
        case 1:
            ...
            if (krisitem)
            {
                current_dialogue = format_text("Kris used the " + string(itemfullname) + "!", 31);
            }
            else if (krismercy)
            {
                current_dialogue = format_text("Kris spared Kreid{\n* But its name wasn't YELLOW...", 60);
            }
            else if (krisactoptions == 0)
            {
                current_dialogue = format_text("KREID - Their anger has boiled over; your words won't get through to them.", 31);
            }
            else if (global.turn > 7 && global.silence1)
            {
                current_dialogue = format_text("You stay silent.", 31);
            }
            else if (global.turn > 7)
            {
                current_dialogue = format_text("You remain silent.", 31);
            }
            else
            {
                if (reason == 1)
                    current_dialogue = format_text("You tell Kreid you never meant to hurt them.", 31);
                
                if (reason == 2)
                    current_dialogue = format_text("You tell Kreid it doesn't have to be this way.", 31);
                
                if (reason == 3)
                    current_dialogue = format_text("You tell Kreid that fighting won't fix anything.", 31);
                
                if (reason == 4)
                    current_dialogue = format_text("You tell Kreid that you can still make things right.", 31);
                
                if (reason == 5)
                    current_dialogue = format_text("You tell Kreid that you're sorry.", 31);
                
                if (reason == 6)
                    current_dialogue = format_text("You tell Kreid", 31);
                
                if (reason >= 7)
                    current_dialogue = format_text("You try to reason with Kreid.", 31);
            }
        ...
        case 2:
            ...
            if (krisactoptions == 1)
            {
                if (reason > 6 || global.turn > 7)
                {
                    ...
                    {
                        texttalk = true;
                        current_dialogue = format_text("If you OUTLAST Kreid's rage, maybe, just maybe...", 31);
                    }
                }
                else
                {
        ...
        case 3:
            ...
            if (krisactoptions == 1)
            {
                switch (reason)
                {
                    case 1:
                        dialogueicon = 1;
                        current_dialogue = format_text("Well, you did anyway!", 28);
                        break;
                    case 3:
                        dialogueicon = 3;
                        current_dialogue = format_text("I was a little distracted kicking your ass.", 28);
                        break;
                    case 4:
                        dialogueicon = 8;
                        current_dialogue = format_text("Put everyone to sleep in seconds!", 28);
                        break;
                    case 5:
                        dialogueicon = 10;
                        current_dialogue = format_text("Don't try to feed me that crap.", 28);
                        break;
                    case 6:
                        dialogueicon = 1;
                        current_dialogue = format_text("At least try to put up a fight instead of insulting me.", 28);
                        break;
                    default:
                        break;
                }
