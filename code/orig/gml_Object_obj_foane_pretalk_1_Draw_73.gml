...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            current_dialogue = format_text("Kris...", 31);
            typing_speed = 1;
            break;
        case 2:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text("You motivated me to come this farfarfarfarfarfar", 31);
            typing_speed = 1;
            break;
        case 3:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text("For that, I'm eternally grateful.", 31);
            typing_speed = 1;
            break;
        case 4:
            window_set_caption("Strings");
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text("Therefore, instead of eliminating you...", 31);
            typing_speed = 0.5;
            blockprogress = true;
            dsongtrigger = true;
        ...
        case 5:
            ...
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text("I will simply capture that blinding light of yours...", 31);
            typing_speed = 0.5;
            break;
        case 6:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text("And keep it locked away forever, so you can never intercept the callcallcallcallcallcall", 31);
            typing_speed = 0.5;
            break;
        case 7:
            foanetalk = true;
            reverbtalk = false;
            charactertalking = false;
            current_dialogue = format_text("Thank you for your time, and farewell!", 31);
            typing_speed = 2/3;
            blockprogress = false;
        ...
        case 8:
            ...
            charactertalking = false;
            textxoffset = -26;
            current_dialogue = "(The SHADOW MANTLE is resonating...)";
            typing_speed = 1;
            break;
        case 9:
            foanetalk = false;
    ...
    if (dialogue == 2)
    {
        var text_parts = string_split(current_dialogue, "far");
        var x_offset = text_x;
        var y_offset = text_y;
    ...
    if (dialogue == 6)
    {
        var text_parts = string_split(current_dialogue, "call");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
