...
if (!noecho)
{
    var s1 = instance_create_depth(x, y, depth, obj_spike_c3_echo);
...
{
    if (place_meeting(x, y, SOUL) && image_alpha >= 0.5)
    {
...
if (place_meeting(x, y, TP) && !SOUL.hurt && image_alpha >= 0.5 && ((pull == 2 && SOUL.pullpercent > 0.2) || (pull == 1 && SOUL.pullpercent <= 0.8)))
{
    tptimer++;
...
if (pull == 2)
{
    ...
    image_yscale = 0.83 * yscalemultiplier;
