...
if (trigger)
{
    ...
    if (characterpick == 0)
        draw_sprite_ext(spr_phoneheads_1, 0, x - 120, y + 4, 2, 2, 0, c_white, image_alpha);
    else if (characterpick == 1)
        draw_sprite_ext(spr_phoneheads_1, 1, x - 120, y + 4, 2, 2, 0, c_white, image_alpha);
    else if (characterpick == 6)
        draw_sprite_ext(spr_phoneheads_1, 2, x - 120, y + 4, 2, 2, 0, c_white, image_alpha);
    else if (characterpick == 66)
        draw_sprite_ext(spr_phoneheads_1, 3, x - 120, y + 4, 2, 2, 0, c_white, image_alpha);
}
