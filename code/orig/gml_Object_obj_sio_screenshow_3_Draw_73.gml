...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("It's footage of Mike alone in the spotlight.", 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text("\"MIKE TONIGHT - Starring Mike T.\"", 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text("His smile is forced.", 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
