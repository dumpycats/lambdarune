...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 11;
            current_dialogue = format_text("This'll really take us straight to the fountain?", 25);
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = format_text("I'm kinda sick of plane rides after tonight.", 25);
            typing_speed = 1;
            dialogueicon = 12;
        ...
        case 3:
            ...
            current_dialogue = format_text("Chairiel said the tower requires shipping in resources by plane.", 25);
            dialogueicon = 9;
            typing_speed = 1;
            break;
        case 4:
            current_dialogue = format_text("She hasn't been wrong so far, so I trust her.", 25);
            typing_speed = 1;
            dialogueicon = 10;
            break;
        case 5:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("As long as it doesn't crash into a green screen this time...", 25);
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
