...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 2;
            current_dialogue = format_text("Are you even listening to yourself right now?", 31);
            typing_speed = 1;
            break;
        case 2:
            tennatalk = false;
            ...
            dialogueicon = 8;
            current_dialogue = format_text("I wasn't for a long time, but I am now.", 25);
            typing_speed = 1;
            break;
        case 3:
            tennatalk = false;
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I can't do this anymore, Tenna- No, Heinrike.", 25);
            typing_speed = 1;
            break;
        case 4:
            tennatalk = false;
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("You and I both know this show can't keep going.", 25);
            typing_speed = 1;
            break;
        case 5:
            tennatalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("Stop being selfish@ We're all our people have left!", 25);
            break;
        case 6:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Do you really want to bring this world back to darker days!?", 25);
            break;
        case 7:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("You saw what happened when we shut down after Loomi...", 25);
            break;
        case 8:
            tennatalk = false;
            miketalk = true;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 8;
            current_dialogue = format_text("I KNOW, I KNOW!", 25);
        ...
        case 9:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 7;
            current_dialogue = format_text("But what about the Lightners?", 25);
        ...
        case 10:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 6;
            current_dialogue = format_text("You heard what they said@ If this fountain stays open...", 25);
        ...
        case 11:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 6;
            current_dialogue = format_text("Bad things will happen to everyone.", 25);
            break;
        case 12:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Did you actually buy that \"Roaring\" nonsense?", 25);
        ...
        case 13:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("I thought you were smarter@ They're manipulating you.", 25);
            break;
        case 14:
            tennatalk = false;
            miketalk = true;
        ...
        case 15:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            current_dialogue = format_text("Our streets haven't been this lit up in years, Mike...", 25);
        ...
        case 16:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("I can't let them take this away from us. Not this time.", 25);
            obj_tenna_sio.image_index = 0;
            break;
        case 17:
            tennatalk = false;
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("We're holding on to something that ended long ago, sis.", 25);
        ...
        case 18:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 8;
            current_dialogue = format_text("And if we make them stay, what'll happen then?", 25);
        ...
        case 19:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 9;
            current_dialogue = format_text("The show continues for another season} Two} Three}", 25);
        ...
        case 20:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("When will the next tragedy come?", 25);
        ...
        case 21:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I can't force them to stay here. I won't.", 25);
            obj_mike_sio.image_index = 7;
            break;
        case 22:
            tennatalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I can't believe you. You've let them fill your head with lies...", 25);
        ...
        case 23:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 7;
            current_dialogue = format_text("Kris{ You made it!", 25);
            obj_mike_sio.image_index = 0;
            break;
        case 24:
            ralseitalk = true;
            ...
            dialogueicon = 0;
            current_dialogue = format_text("Tenna, sealing the fountain isn't the end of everything.", 25);
            break;
        case 25:
            ralseitalk = false;
            susietalk = true;
            ...
            dialogueicon = 3;
            current_dialogue = format_text("Yeah{ We aren't just going to leave you here.", 25);
            break;
        case 26:
            ralseitalk = true;
            susietalk = false;
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("In Castle Town, all kinds of Darkners live together peacefully.", 25);
            break;
        case 27:
            ralseitalk = true;
            miketalk = false;
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 26;
            current_dialogue = format_text("You and all your people can come there. There's plenty of room!", 25);
            break;
        case 28:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Oh, how convenient!", 25);
            obj_tenna_sio.sprite_index = spr_tenna_wary;
        ...
        case 29:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("A fancy little town that can solve all our problems.", 25);
            break;
        case 30:
            tennatalk = false;
            susietalk = true;
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 20;
            current_dialogue = format_text("You think Ralsei, Lancer and Rouxls just showed up out of nowhere?", 25);
            break;
        case 31:
            tennatalk = true;
            susietalk = false;
        ...
        case 32:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text("Even if you three are telling the truth, what would that change?", 25);
            obj_mike_sio.image_index = 7;
            break;
        case 33:
            tennatalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("If you seal this fountain, who's to say that town won't be next?", 26);
            break;
        case 34:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            current_dialogue = format_text("We'll end up the same no matter what fountain we call home.", 25);
            obj_tenna_sio.sprite_index = spr_tenna_wary;
            obj_tenna_sio.image_index = 1;
            break;
        case 35:
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Things will be different this time, sis. I trust them.", 25);
            obj_tenna_sio.sprite_index = spr_tenna_neutral;
            obj_tenna_sio.image_index = 2;
        ...
        case 37:
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 8;
            current_dialogue = format_text("Sorry, Mike.", 25);
            obj_mike_sio.image_index = 7;
            break;
        case 38:
            tennatalk = false;
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("...For wh ", 25);
            obj_mike_sio.image_index = 6;
            during38timer++;
        ...
        case 39:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 19;
            current_dialogue = format_text("The hell are you doing!?", 25);
            break;
        case 40:
            tennatalk = true;
            susietalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            current_dialogue = format_text("Changing the channel.", 25);
            obj_tenna_sio.image_index = 1;
            break;
        case 41:
            tennatalk = true;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("He'll be fine. I just can't let him listen to any more of this.", 25);
            break;
        case 42:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            current_dialogue = format_text("And while he's asleep...", 25);
            break;
        case 43:
            tennatalk = true;
            miketalk = false;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text("WE'LL dispose of you.", 25);
            break;
        case 44:
            tennatalk = false;
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 12;
            current_dialogue = format_text("...Mike?", 31);
            break;
        case 45:
            tennatalk = true;
            ralseitalk = false;
            ...
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Hah!", 31);
            break;
        case 46:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Kris, Kris, Kris...", 31);
            break;
        case 47:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Do you think you can show up in MY world and seal MY fountain...", 31);
            break;
        case 48:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("And pretend you're friends with my brother?", 31);
            break;
        case 49:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("You're a fool... I'm done with you.", 31);
            break;
        case 50:
            tennatalk = true;
            ralseitalk = false;
            dialogueiconchoice = sMikeDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("Mike won't be deceived by your tricks anymore.", 31);
            break;
        case 51:
            tennatalk = true;
            ralseitalk = false;
            ...
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text("This show's over.", 25);
