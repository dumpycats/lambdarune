...
switch (global.dialogue)
{
    case 1:
        ...
        global.current_dialogue = "* ENTERTAIN ME. I'M SO BORED,\n  MEW!";
    ...
    case 2:
        ...
        global.charactertalking = false;
        global.current_dialogue = "* entertain\n  yourselfselfselfselfselfself";
        global.typing_speed = 1;
        pitchtimer = 0;
        break;
    case 3:
        ...
        global.feighlinetalk = true;
        global.charactertalking = false;
        global.current_dialogue = "* WHY DO YOU LIKE COMING HERE}\n  THERE'S NOTHING.";
        global.typing_speed = 1;
        pitchtimer++;
    ...
    case 4:
        ...
        global.feighlinetalk = false;
        global.charactertalking = false;
        global.current_dialogue = "* exactly, nobody comes here@\n  i can just sit without any\n  worries...";
        global.typing_speed = 1;
        audio_sound_pitch(snd_foane, 1);
        break;
    case 5:
        ...
        global.feighlinetalk = false;
        global.charactertalking = false;
        global.current_dialogue = "* it's perfect.";
        global.typing_speed = 1;
        break;
    case 6:
        global.foanetalk = true;
        global.feighlinetalk = false;
        global.charactertalking = false;
        global.current_dialogue = "* ...that is, except for when\n  you talktalktalktalktalktalk";
        global.typing_speed = 1;
        break;
    case 7:
