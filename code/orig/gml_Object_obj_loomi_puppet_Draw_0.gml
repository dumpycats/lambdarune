...
draw_sprite_ext(sprite_index, 1, xhead, y, 2, 2, 0, c_white, image_alpha);
...
if (shift)
{
    shifttimer++;
    percent2 = 0;
    xoffset0 = sin((shifttimer / 15) * (2 * pi)) * 2;
    xoffset1 = sin((shifttimer / 12) * (2 * pi)) * 2;
    angle1 = sin((shifttimer / 12) * (2 * pi)) * 4;
    xoffset2 = sin((shifttimer / 9) * (2 * pi)) * 2;
    angle2 = sin((shifttimer / 9) * (2 * pi)) * 7;
}
else
{
    shifttimer = -1;
