...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text("It's footage of Mike, Foane, and a woman you don't recognize.", 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text("\"LOOMI TUNES - Starring Loomi Neus, Mike & Foane T.\"", 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text("They all seem happy together.", 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
