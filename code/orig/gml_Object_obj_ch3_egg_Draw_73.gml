...
if (talking)
{
    ...
    {
        case 1:
            current_dialogue = format_text("Well, there is a man here.", 31);
            break;
        case 2:
            current_dialogue = format_text("He asks if you enjoyed the film.", 31);
            break;
        case 3:
            endcasequestion1 = dialogue;
            current_dialogue = format_text("What do you think?", 31);
            break;
        case 4:
            audio_stop_sound(mus_man_ragtime);
            endcasebad = dialogue;
            current_dialogue = format_text("Then he needn't be here.", 31);
            window_set_caption("");
            break;
        case 5:
            current_dialogue = format_text("The man seems glad you keep going out of your way to meet him.", 31);
            break;
        case 6:
            current_dialogue = format_text("He held something in his hand and smiled.", 31);
            break;
        case 7:
            current_dialogue = format_text("The man can tell you're confused, but he reassures you.", 31);
            break;
        case 8:
            current_dialogue = format_text("\"You will understand in due time.\"", 31);
            break;
        case 9:
            current_dialogue = format_text("Do you understand?", 31);
            break;
        case 10:
            audio_stop_sound(mus_man_ragtime);
            current_dialogue = format_text("You got the Egg.", 31);
            window_set_caption("");
            break;
        case 11:
            endcasefinal = dialogue;
            current_dialogue = format_text("Well, there was not a man here.", 31);
            break;
        default:
            current_dialogue = "";
            break;
...
if (yesnooption)
{
    ...
    if (options == 0)
    {
        ...
        draw_text_color(cx + 92, cy + 371, "Yes", c_white, c_white, c_white, c_white, 1);
        draw_text_color(cx + 556, cy + 371, "No", c_white, c_white, c_white, c_white, 1);
    }
    
    if (options == 1)
    {
        draw_sprite_ext(spr_menu_SOUL, 0, cx + 69, cy + 387, 1, 1, 0, c_white, 1);
        draw_text_color(cx + 92, cy + 371, "Yes", c_yellow, c_yellow, c_yellow, c_yellow, 1);
        draw_text_color(cx + 556, cy + 371, "No", c_white, c_white, c_white, c_white, 1);
    ...
    if (options == 2)
    {
        ...
        draw_text_color(cx + 92, cy + 371, "Yes", c_white, c_white, c_white, c_white, 1);
        draw_text_color(cx + 556, cy + 371, "No", c_yellow, c_yellow, c_yellow, c_yellow, 1);
