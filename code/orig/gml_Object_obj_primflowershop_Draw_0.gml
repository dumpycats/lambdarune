...
if (buymenu)
{
    ...
    if (buyoptions == 0)
        draw_text(440, 231 + yoffset, "ITEM\nFloral   Tea\nheals   team\n???HP");
    
    if (buyoptions == 1)
    {
        draw_text(440, 231 + yoffset, "ARMOR\nSensational\ndefense");
    ...
    if (buyoptions == 3)
    {
        draw_text(440, 231 + yoffset, "WEAPON\nWoven  from\nplant   matter");
...
if (buymenu)
{
    ...
    if (!teabought)
    {
        draw_text(60, 264, "Buttercan   Tea");
        draw_text(300, 264, "FREE");
    }
    else
    {
        draw_text_color(60, 264, "[SOLD   OUT]", c_gray, c_gray, c_gray, c_gray, 1);
    }
    
    draw_text(60, 304, "Tabloid   Sash");
    draw_text(300, 304, "$260");
    draw_text(60, 344, "Junkfood");
    draw_text(300, 344, "$100");
    draw_text(60, 384, "Wicker   Scarf");
    draw_text(300, 384, "$420");
    draw_text(60, 424, "Exit");
...
if (mainmenu)
{
    ...
    draw_text_with_tracking(480, 264, "Buy\nSell\nTalk\nExit", 16777215, 0, 8);
    yoffset = 0;
    percentbuy = 0;
...
{
    draw_set_font(fDeterminationSans);
    draw_text_with_tracking(440, 424, "$" + string(global.money), 16777215, 0, 7);
}
...
if (talkmenu)
{
    ...
    if (!yourselftalked)
        draw_text(80, 264, "About   yourself");
    else
        draw_text_color(80, 264, "Journey", c_yellow, c_yellow, c_yellow, c_yellow, 1);
    
    draw_text(80, 304, "Mike   and   Tenna");
    draw_text(80, 344, "The   Knight");
    
    if (!freedomtalked)
        draw_text(80, 384, "Freedom");
    else
        draw_text_color(80, 384, "Shadow   Crystal", c_yellow, c_yellow, c_yellow, c_yellow, 1);
    
    draw_text(80, 424, "Exit");
