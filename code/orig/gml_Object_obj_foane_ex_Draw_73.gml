...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 18;
            current_dialogue = format_text("...That's...!", 25);
            typing_speed = 1;
            break;
        case 2:
            susietalk = false;
            ...
            current_dialogue = format_text("I tried to reject you for so long.", 31);
            typing_speed = 1;
            break;
        case 3:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I hated the part of me that still held hope.", 31);
            typing_speed = 1;
            break;
        case 4:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I hated it so much that it split me in twotwotwotwotwotwo", 31);
            typing_speed = 1;
            break;
        case 5:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("But now} My mind is becoming whole again.", 31);
            typing_speed = 1;
            break;
        case 6:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I can't keep talking to myself forever, so this is goodbye, Feighline...", 31);
            typing_speed = 1;
            break;
        case 7:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("And with that...", 31);
            typing_speed = 1;
            break;
        case 8:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("Everything is brought to perfect harmony.", 31);
            typing_speed = 1;
            break;
        case 9:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 27;
            current_dialogue = format_text("Foane!", 25);
            typing_speed = 1;
            break;
        case 10:
            susietalk = false;
            emptytalk = true;
            charactertalking = false;
            current_dialogue = format_text("You rang?", 31);
            typing_speed = 1/3;
        ...
        case 11:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("Ahem@ Sorry, that was a bit silly.", 31);
            typing_speed = 1;
            break;
        case 12:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("After absorbing Loomi Neus, I grew a bit of a funny bonebonebonebonebonebone", 31);
            typing_speed = 1;
            break;
        case 13:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("If I start laughing, I might not be able to stop myself.", 31);
            typing_speed = 1;
        ...
        case 14:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("Mike thought the safest place to seal Loomi Neus was within his robot form...", 31);
            typing_speed = 1;
            break;
        case 15:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I felt bad having to tear her out of him.", 31);
            typing_speed = 1;
        ...
        case 16:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = "* It feels so good to SMILE\n  again!";
            typing_speed = 1;
            break;
        case 17:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 19;
            current_dialogue = format_text("Why did you take over the Dark World?", 25);
            typing_speed = 1;
            break;
        case 18:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 35;
            current_dialogue = format_text("We cleared every channel, we stopped your brother and sister...", 25);
            typing_speed = 1;
            break;
        case 19:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 18;
            current_dialogue = format_text("What else is left for you to do!?", 25);
            typing_speed = 1;
            image_index = 2;
            break;
        case 20:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("You're thinking too small, Susie.", 31);
            typing_speed = 1;
            break;
        case 21:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("There's a bigger picture, and none of you see it!", 31);
            typing_speed = 1;
            break;
        case 22:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I'm not on some vain quest for power, or status, or anything else...", 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 23:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I'm answering a call@ The same call I heard all those years agoagoagoagoagoago", 31);
            typing_speed = 1;
            break;
        case 24:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I'll pull this world's strings, using them to capture this frequency...", 31);
            typing_speed = 1;
            image_index = 2;
            break;
        case 25:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("And with it, I'll break my OWN strings!", 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 26:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("No more wasting away, dreaming of what I can't havehavehavehavehavehave", 31);
            typing_speed = 1;
            break;
        case 27:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I'm finally dialing things up!", 31);
            typing_speed = 1;
            image_index = 0;
        ...
        case 28:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("Apologies.", 31);
            typing_speed = 1;
            break;
        case 29:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("As for you three, I think you should sing a different tune...", 31);
            typing_speed = 1;
            break;
        case 30:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("And join me.", 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 31:
            ...
            dialogueicon = 34;
            current_dialogue = format_text("Join you!?", 25);
            typing_speed = 1;
            break;
        case 32:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("You're trying to keep me from my goal, but it would be a waste to fight.", 31);
            typing_speed = 1;
            break;
        case 33:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("You're all like me@ I know you have the potential to pull your own strings...", 31);
            typing_speed = 1;
            break;
        case 34:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("So please, hear the resonance@ Defy your destinies with me!", 31);
            typing_speed = 1;
            sprite_index = spr_foane_ex_raise;
            image_index = 3;
            break;
        ...
        case 36:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("I was worried this would happen.", 31);
            typing_speed = 1;
            break;
        case 37:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("Oh well.", 31);
            typing_speed = 1;
            break;
        case 38:
            ralseitalk = true;
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 35;
            current_dialogue = format_text("(Those strings...)", 25);
            typing_speed = 1;
            break;
        case 39:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text("No hard feelings.", 31);
            typing_speed = 1;
    ...
    if (dialogue == 4)
    {
        var text_parts = string_split(current_dialogue, "two");
        var x_offset = text_x;
        var y_offset = text_y;
    ...
    if (dialogue == 12)
    {
        var text_parts = string_split(current_dialogue, "bone");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
    ...
    if (dialogue == 16)
    {
        var text_parts = string_split(current_dialogue, "SMILE");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
    ...
    if (dialogue == 23)
    {
        var text_parts = string_split(current_dialogue, "ago");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
    ...
    if (dialogue == 26)
    {
        var text_parts = string_split(current_dialogue, "have");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
