...
switch (global.dialogue)
{
    ...
    case 3:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* Kris, where-";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 4:
    ...
    case 5:
        global.susietalk = true;
        global.charactertalking = true;
        global.current_dialogue = "* Is your, uh, mom around?";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 6:
    ...
    case 8:
        global.susietalk = true;
        global.charactertalking = true;
        global.current_dialogue = "* Okay, so...";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 9:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* WHERE THE HELL ARE WE!?";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 10:
        ...
        oSusieC3.x = 320;
        global.charactertalking = true;
        global.current_dialogue = "* This isn't your house\n  for sure.";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 11:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* Is this a dream or\n  something??";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 12:
    ...
    case 13:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* A Dark Fountain!?";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 14:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* But if this isn't a\n  dream, then who opened\n  one in your house?";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 15:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* It's definitely not you\n  or me, but that means...";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 16:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* Naaah, that would be\n  stupid.";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 17:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* Dammit, that Knight guy\n  must have snuck in...";
        global.typing_speed = 1;
        blockprogress = false;
        knighttexttimer++;
    ...
    case 18:
        ...
        oDialogueSprite.image_index = 4;
        global.charactertalking = true;
        global.current_dialogue = "* And opened this Dark\n  World while we were\n  sleeping.";
        global.typing_speed = 1;
        blockprogress = false;
    ...
    case 20:
        ...
        global.charactertalking = true;
        global.current_dialogue = "* ...I guess we should\n  start heading towards\n  the fountain.";
        global.typing_speed = 1;
        blockprogress = false;
        break;
    case 21:
        ...
        oDialogueSprite.image_index = 17;
        global.charactertalking = true;
        global.current_dialogue = "* And kick the Knight's\n  ass for making us save\n  the world THREE times!";
        global.typing_speed = 1;
        blockprogress = false;
        window_set_caption("ROARING ASS");
        knightastexttimer++;
