...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 2;
            current_dialogue = format_text("Ha...", 31);
            typing_speed = 1;
            break;
        case 2:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Hahahaha...!", 31);
            typing_speed = 1;
            break;
        case 3:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Loomi's heart... my heart... they both beat in sync!", 31);
            typing_speed = 1;
            break;
        case 4:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I feel closer to that heavenly signal than ever before!", 31);
            typing_speed = 1;
            break;
        case 5:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Impressive work, pulling all those strings...", 31);
            typing_speed = 1;
            break;
        case 6:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("But your disCORDant signals will never breach my harmony!", 31);
            typing_speed = 1;
            endcase1 = dialogue;
            break;
        case 7:
        ...
        case 8:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("W-what...?", 31);
            typing_speed = 1;
            break;
        case 9:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("What's going on...?", 31);
            typing_speed = 1;
            break;
        case 10:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("The resonance... I can't... I can't hear it.", 31);
            typing_speed = 1;
            endcase3 = dialogue;
            break;
        case 11:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("No...", 31);
            typing_speed = 1;
            endcase15 = dialogue;
            break;
        case 12:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Still swinging away, little heroes?", 31);
            typing_speed = 1;
            break;
        case 13:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Or have you realized that these strings CAN'T be cut?", 31);
            typing_speed = 1;
            break;
        case 14:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Only I can pull them, and only I can break themthemthemthemthemthem!", 31);
            typing_speed = 1;
            foanes1 = dialogue;
        ...
        case 15:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Keep draining my energy@ It won't matter.", 31);
            typing_speed = 1;
            break;
        case 16:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("As long as that hymn courses through me, I can keep fighting!", 31);
            typing_speed = 1;
            break;
        case 17:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I can...", 31);
            typing_speed = 1;
            endcase2 = dialogue;
        ...
        case 18:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("H-Huh...?", 31);
            typing_speed = 1;
            break;
        case 19:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("My body's... giving upupupupupup?", 31);
            typing_speed = 1;
            endcase4 = dialogue;
            foanes2 = dialogue;
        ...
        case 20:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("No{ Stay up, STAY UP!", 31);
            typing_speed = 1;
            break;
        case 21:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("It can't end here!!", 31);
            typing_speed = 1;
            break;
        case 22:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("It... can't...", 31);
            typing_speed = 1;
            endcase15 = dialogue;
            break;
        case 23:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I... lost the signal.", 31);
            typing_speed = 1;
            d23timer++;
        ...
        case 24:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("All those thoughts...", 31);
            typing_speed = 1;
            break;
        case 25:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Were any of them... truetruetruetruetruetrue?", 31);
            typing_speed = 1;
            foanes3 = dialogue;
        ...
        case 26:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Or have I failed... again?", 31);
            typing_speed = 1;
            break;
        case 27:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I was right@ It is truly impossible.", 31);
            typing_speed = 1;
            break;
        case 28:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Nothing I do matters, and it never will@ Once I let go, I'll be back to square one.", 31);
            typing_speed = 1;
            endcase6 = dialogue;
            break;
        case 29:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("...Even now, you still think it's possible?", 31);
            typing_speed = 1;
        ...
        case 30:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("After everything, you haven't given up?", 31);
            typing_speed = 1;
            break;
        case 31:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Hahaha...", 31);
            typing_speed = 1;
        ...
        case 32:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Thank you.", 31);
        ...
        case 33:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Don't worry about me, Kris.", 31);
            typing_speed = 1;
        ...
        case 34:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Even though my journey is ending in a flatline...", 31);
            typing_speed = 1;
            break;
        case 35:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("I feel... acceptance.", 31);
            typing_speed = 1;
            obj_foane_ex_aftermath.image_index = 0;
            break;
        case 36:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("That freedom I've spent so long chasing clearly isn't mine to take.", 31);
            typing_speed = 1;
            break;
        case 37:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("But you} There's still hope for you.", 31);
            typing_speed = 1;
            obj_foane_ex_aftermath.image_index = 2;
            break;
        case 38:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("While others fall to despair, you can climb to the top.", 31);
            typing_speed = 1;
            break;
        case 39:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Answer the call and set yourself freefreefreefreefreefree", 31);
            typing_speed = 1;
            foanes4 = dialogue;
            break;
        case 40:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Who knows} Maybe you'll keep that promise...", 31);
            typing_speed = 1;
            break;
        case 41:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("...and eventually save me.", 31);
            typing_speed = 1;
            endcase8 = dialogue;
            break;
        case 42:
        ...
        case 48:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Answer the call@ Set yourself freefreefreefreefreefree", 31);
            typing_speed = 1;
            endcase8 = dialogue;
            foanes4 = dialogue;
            break;
        case 49:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("Hopefully you get some use out of this.", 31);
            typing_speed = 1;
            endcase9 = dialogue;
            break;
        case 50:
            ...
            if (!instance_exists(obj_foane_attackcheck))
                current_dialogue = format_text("(You got EarRinger.)", 31);
            else
                current_dialogue = format_text("(You got WireCutter.)", 31);
        ...
        case 51:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("(You got ShadowCrystal.)", 31);
            typing_speed = 1;
            break;
        case 52:
            foanetalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text("... See you soon, Kris.", 31);
            typing_speed = 1;
            endcase10 = dialogue;
            obj_foane_ex_aftermath.image_index = 0;
            d52timer++;
        ...
        case 53:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("Okay... there's no way we can pretend THAT didn't just happen.", 25);
            dialogueicon = 27;
            typing_speed = 1;
        ...
        case 54:
            ...
            current_dialogue = format_text("Susie...", 25);
            dialogueicon = 4;
            typing_speed = 1;
            break;
        case 55:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("Three times in a row} Something's wrong here.", 25);
            dialogueicon = 4;
            typing_speed = 1;
        ...
        case 56:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("I'm tired of being kept in the dark about this. ", 25);
            dialogueicon = 37;
            typing_speed = 1;
            break;
        case 57:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("... What's going on, Kris?", 25);
            dialogueicon = 0;
            typing_speed = 1;
        ...
        case 58:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text("Kris is probably worn out after", 25);
            dialogueicon = 26;
            typing_speed = 1;
        ...
        case 59:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("If I wanted your opinion, I would've asked!", 25);
            dialogueicon = 19;
            typing_speed = 1;
        ...
        case 62:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("... Ugh, sorry@ I just...", 25);
            dialogueicon = 13;
            typing_speed = 1;
            obj_susie_sof_end.sprite_index = sSusieWalkDownUpset;
            break;
        case 63:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text("I'll... see you guys in Castle Town.", 25);
            dialogueicon = 30;
            typing_speed = 1;
        ...
        case 65:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text("The fountain should be clear now.", 31);
            dialogueicon = 0;
            typing_speed = 1;
            break;
        case 66:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text("I'll see you soon, Kris.", 25);
            dialogueicon = 41;
            typing_speed = 1;
            endcase13 = dialogue;
            break;
    ...
    if (dialogue == foanes1)
    {
        var text_parts = string_split(current_dialogue, "them");
        var x_offset = text_x;
        var y_offset = text_y;
    ...
    if (dialogue == foanes2)
    {
        var text_parts = string_split(current_dialogue, "up");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
    ...
    if (dialogue == foanes3)
    {
        var text_parts = string_split(current_dialogue, "true");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
    ...
    if (dialogue == foanes4)
    {
        var text_parts = string_split(current_dialogue, "free");
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
