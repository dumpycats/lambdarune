if (checkonce)
{
    ...
    instance_create_depth(0, 0, 0, obj_controller_z);
    instance_create_depth(0, 0, 0, obj_controller_x);
    instance_create_depth(0, 0, 0, obj_controller_c);
    instance_create_depth(0, 0, 0, obj_controller_r);
    instance_create_depth(0, 0, 0, obj_controller_n);
    instance_create_depth(0, 0, 0, obj_controller_esc);
    instance_create_depth(0, 0, 0, obj_controller_joystick);
    checkonce = false;
}

androidsavetimer++;

if (androidsavetimer == 1 && true)
{
