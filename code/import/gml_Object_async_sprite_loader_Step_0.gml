...
else
{
    ...
    var i = 0;
    for (i = 0; i < ds_list_size(sprites_to_load); i++)
    {
    ...
    {
        var file = ds_list_find_value(heavy_sprites_to_load, i);
        ...
        {
            translation_sprite_add(sprite_name, directory + file, sprite_properties, sprites_map);
        }
