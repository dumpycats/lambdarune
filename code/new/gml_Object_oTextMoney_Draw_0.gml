...
var text = translation_get_string("gml_Object_oTextMoney_Draw_0_0") + string(global.money);
var text_x = 438;
var text_y = 419;
...
for (var i = 1; i <= string_length(text); i++)
{
    ...
    if (current_char == translation_get_string("gml_Object_oTextMoney_Draw_0_1"))
    {
        text_x = 438;
