...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 9;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_0"), 25);
            typing_speed = 1;
            break;
        case 2:
            quip = false;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_1"), 25);
            typing_speed = 1;
            dialogueicon = 5;
            break;
        case 3:
            ...
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_2"), 25);
            dialogueicon = 0;
            typing_speed = 1;
            break;
        case 4:
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_3"), 25);
            typing_speed = 1;
            dialogueicon = 10;
            break;
        case 5:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 20;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_4"), 25);
            typing_speed = 1;
        ...
        case 6:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_5"), 25);
            dialogueicon = 7;
            typing_speed = 1;
            break;
        case 7:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 22;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_6"), 25);
            typing_speed = 1;
            break;
        case 8:
            susietalk = true;
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_7"), 25);
            dialogueicon = 15;
            typing_speed = 1;
            break;
        case 9:
            ...
            ralseitalk = false;
            texttalk = true;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_8"), 25);
            typing_speed = 1;
        ...
        case 10:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_9"), 25);
            dialogueicon = 5;
            typing_speed = 1;
            break;
        case 11:
            ...
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_10"), 25);
            dialogueicon = 11;
            typing_speed = 1;
            break;
        case 12:
            quip = true;
            quipstring = lang("obj_plane_text_Draw_73_11");
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_12"), 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 13:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_13"), 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 14:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_14"), 25);
            dialogueicon = 8;
            typing_speed = 1;
            break;
        case 15:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_15"), 25);
            dialogueicon = 13;
            typing_speed = 1;
            break;
        case 16:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_16"), 25);
            dialogueicon = 12;
            typing_speed = 1;
            break;
        case 17:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_17"), 25);
            dialogueicon = 2;
            typing_speed = 1;
            break;
        case 18:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_18"), 25);
            dialogueicon = 9;
            typing_speed = 1;
        ...
        case 19:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 18;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_19"), 25);
            typing_speed = 1;
            blockprogress = true;
            d19timer++;
        ...
        case 20:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 30;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_20"), 25);
            typing_speed = 1;
            blockprogress = true;
            d20timer++;
        ...
        case 21:
            ...
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_21"), 31);
            typing_speed = 1;
            blockprogress = false;
        ...
        case 22:
            ...
            ralseitalk = false;
            charactertalking = false;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_22"), 31);
            typing_speed = 1;
            blockprogress = false;
        ...
        case 23:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_23"), 25);
            dialogueicon = 1;
            typing_speed = 1;
        ...
        case 24:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_24"), 25);
            dialogueicon = 10;
            typing_speed = 1;
            break;
        case 25:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_25"), 25);
            dialogueicon = 9;
            typing_speed = 1;
        ...
        case 26:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_26"), 25);
            dialogueicon = 14;
            typing_speed = 1;
        ...
        case 27:
            ...
            ralseitalk = false;
            dialogueiconchoice = sKreidDialogueSprite;
            current_dialogue = format_text(lang("obj_plane_text_Draw_73_27"), 25);
            dialogueicon = 15;
            typing_speed = 1;
            ...
            break;
        default:
            current_dialogue = lang("obj_plane_text_Draw_73_28");
            break;
    }
    ...
    if (!text_complete && !pause_for_punctuation)
    {
        ...
        while (typing_timer >= 1)
        {
            ...
            if (letter_index < string_length(current_dialogue))
            {
                ...
                var following_char = ((letter_index + 2) <= string_length(current_dialogue)) ? string_char_at(current_dialogue, letter_index + 2) : lang("obj_plane_text_Draw_73_29");
        ...
        if (text_complete)
        {
            ...
            if (array_contains(endcase, dialogue))
            {
                ...
                if (array_contains(gigcase, dialogue))
                {
                    ...
                    reveal = true;
                    window_set_caption(lang("obj_plane_text_Draw_73_30"));
                }
