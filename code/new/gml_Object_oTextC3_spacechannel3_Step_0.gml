...
switch (global.dialogue)
{
    case 1:
        ...
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_0");
    ...
    case 2:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_1");
        global.typing_speed = 1;
        obj_foane_spacechannel.sprite_index = spr_foane_feighline_up;
    ...
    case 3:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_2");
        global.typing_speed = 1;
        pitchtimer++;
    ...
    case 4:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_3");
        global.typing_speed = 1;
        obj_foane_spacechannel.sprite_index = spr_foane_feighline_up;
        obj_foane_spacechannel.image_speed = 0;
        break;
    case 5:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_4");
        global.typing_speed = 1;
    ...
    case 6:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_5");
        global.typing_speed = 1;
        obj_foane_spacechannel.sprite_index = spr_foane_feighline_up;
        obj_foane_spacechannel.image_speed = 0;
        break;
    ...
    case 8:
        ...
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel3_Step_0_6");
        global.typing_speed = 1;
