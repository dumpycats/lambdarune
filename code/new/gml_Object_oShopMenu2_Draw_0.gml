...
if (global.buyitems == 1)
    text = translation_get_string("oShopMenu2_Draw_0_0");

if (global.buyitems == 2)
    text = translation_get_string("oShopMenu2_Draw_0_1");

if (global.buyitems == 3)
    text = translation_get_string("oShopMenu2_Draw_0_2");

if (global.buyitems == 4)
    text = translation_get_string("oShopMenu2_Draw_0_3");
