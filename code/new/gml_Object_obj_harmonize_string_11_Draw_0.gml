...
if (!(interacttimer >= 30 && right))
{
    ...
    var tex1 = sprite_get_texture(spr_harmonize_1, 11);
    var uvs1 = sprite_get_uvs(spr_harmonize_1, 11);
    shader_set_uniform_f(shader_get_uniform(sh_wavewarp, "u_time"), (current_time / 1000) + 1234);
...
if (global.harmonyphase == 3 && !(interacttimer >= 30 && right))
{
    draw_sprite_ext(spr_harmonize_1, 11, cx + 320, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_1, 11, cx + 320, cy + 116, 1, 1, 0, c_white, image_alpha);
}
else
{
    draw_sprite_ext(spr_harmonize_split_4, harmonysplit, cx + 320, cy + 116, 1, 1, 0, c_white, image_alpha);
    draw_sprite_ext(spr_harmonize_split_4, harmonysplit, cx + 320, cy + 116, 1, 1, 0, c_white, image_alpha);
    harmonysplit += (2/3);
