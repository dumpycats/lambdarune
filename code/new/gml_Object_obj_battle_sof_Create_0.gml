...
window_set_caption(get_lang_string("gml_Object_obj_battle_sof_Create_0_0"));
debug = false;
...
jamtext = "";
tennatext = "";
ACTNAME = get_lang_string("gml_Object_obj_battle_sof_Create_0_1");
blockprogress = false;
skiptext = false;
skiptimer = 0;
...
ENEMYNAME = get_lang_string("gml_Object_obj_battle_sof_Create_0_2");
...
define_item(ITEM_KREID, get_lang_string("gml_Object_obj_battle_sof_Create_0_3"), get_lang_string("gml_Object_obj_battle_sof_Create_0_4"), get_lang_string("gml_Object_obj_battle_sof_Create_0_5"), 140, false);
define_item(ITEM_DONUT, get_lang_string("gml_Object_obj_battle_sof_Create_0_6"), get_lang_string("gml_Object_obj_battle_sof_Create_0_7"), get_lang_string("gml_Object_obj_battle_sof_Create_0_8"), 70, false);
define_item(ITEM_MILK, get_lang_string("gml_Object_obj_battle_sof_Create_0_9"), get_lang_string("gml_Object_obj_battle_sof_Create_0_10"), get_lang_string("gml_Object_obj_battle_sof_Create_0_11"), 100, true);
define_item(ITEM_STRUDEL, get_lang_string("gml_Object_obj_battle_sof_Create_0_12"), get_lang_string("gml_Object_obj_battle_sof_Create_0_13"), get_lang_string("gml_Object_obj_battle_sof_Create_0_14"), 90, false);
define_item(ITEM_BTEA, get_lang_string("gml_Object_obj_battle_sof_Create_0_15"), get_lang_string("gml_Object_obj_battle_sof_Create_0_16"), get_lang_string("gml_Object_obj_battle_sof_Create_0_17"), 777, true);
define_item(ITEM_SPINCAKE, get_lang_string("gml_Object_obj_battle_sof_Create_0_18"), get_lang_string("gml_Object_obj_battle_sof_Create_0_19"), get_lang_string("gml_Object_obj_battle_sof_Create_0_20"), 140, true);
define_item(ITEM_TEA, get_lang_string("gml_Object_obj_battle_sof_Create_0_21"), get_lang_string("gml_Object_obj_battle_sof_Create_0_22"), get_lang_string("gml_Object_obj_battle_sof_Create_0_23"), 10, false);
define_item(ITEM_TV, get_lang_string("gml_Object_obj_battle_sof_Create_0_24"), get_lang_string("gml_Object_obj_battle_sof_Create_0_25"), get_lang_string("gml_Object_obj_battle_sof_Create_0_26"), 110, false);
define_item(ITEM_REVIVE, get_lang_string("gml_Object_obj_battle_sof_Create_0_27"), get_lang_string("gml_Object_obj_battle_sof_Create_0_28"), get_lang_string("gml_Object_obj_battle_sof_Create_0_29"), 999, false);
