...
window_set_caption(lang("obj_battle_sof_Create_0_0"));
debug = false;
...
dialoguexoffset = 0;
dialogueyoffset = 0;
current_dialogue = lang("obj_battle_sof_Create_0_1");
displayed_text = "";
letter_index = 0;
sound_playing = false;
text_complete = false;
...
generator2 = false;
jamphase = 0;
jamtext = lang("obj_battle_sof_Create_0_2");
tennatext = lang("obj_battle_sof_Create_0_3");
ACTNAME = lang("obj_battle_sof_Create_0_4");
blockprogress = false;
skiptext = false;
skiptimer = 0;
...
ENEMYNAME = lang("obj_battle_sof_Create_0_5");
...
used_itemr = 0;
empty = 666;
itemfullname = lang("obj_battle_sof_Create_0_6");
...
define_item(ITEM_KREID, lang("obj_battle_sof_Create_0_7"), lang("obj_battle_sof_Create_0_8"), lang("obj_battle_sof_Create_0_9"), 140, false);
define_item(ITEM_DONUT, lang("obj_battle_sof_Create_0_10"), lang("obj_battle_sof_Create_0_11"), lang("obj_battle_sof_Create_0_12"), 70, false);
define_item(ITEM_MILK, lang("obj_battle_sof_Create_0_13"), lang("obj_battle_sof_Create_0_14"), lang("obj_battle_sof_Create_0_15"), 100, true);
define_item(ITEM_STRUDEL, lang("obj_battle_sof_Create_0_16"), lang("obj_battle_sof_Create_0_17"), lang("obj_battle_sof_Create_0_18"), 90, false);
define_item(ITEM_BTEA, lang("obj_battle_sof_Create_0_19"), lang("obj_battle_sof_Create_0_20"), lang("obj_battle_sof_Create_0_21"), 777, true);
define_item(ITEM_SPINCAKE, lang("obj_battle_sof_Create_0_22"), lang("obj_battle_sof_Create_0_23"), lang("obj_battle_sof_Create_0_24"), 140, true);
define_item(ITEM_TEA, lang("obj_battle_sof_Create_0_25"), lang("obj_battle_sof_Create_0_26"), lang("obj_battle_sof_Create_0_27"), 10, false);
define_item(ITEM_TV, lang("obj_battle_sof_Create_0_28"), lang("obj_battle_sof_Create_0_29"), lang("obj_battle_sof_Create_0_30"), 110, false);
define_item(ITEM_REVIVE, lang("obj_battle_sof_Create_0_31"), lang("obj_battle_sof_Create_0_32"), lang("obj_battle_sof_Create_0_33"), 999, false);
define_item(ITEM_EMPTY, lang("obj_battle_sof_Create_0_34"), lang("obj_battle_sof_Create_0_35"), lang("obj_battle_sof_Create_0_36"), 0, false);
