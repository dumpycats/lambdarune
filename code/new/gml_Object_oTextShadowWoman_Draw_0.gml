...
for (var i = 1; i <= string_length(global.displayed_text); i++)
{
    ...
    if (current_char == translation_get_string("gml_Object_oTextShadowWoman_Draw_0_0"))
    {
        if (global.shoptalkmenu == false)
            text_x = 30;
        else
    ...
    else
    {
        ...
        draw_text_color(text_x + 1, text_y + 1, current_char, shadow_color1, shadow_color1, shadow_color, shadow_color, 1);
        draw_set_color(c_white);
