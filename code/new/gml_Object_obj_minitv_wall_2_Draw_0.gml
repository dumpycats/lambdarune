...
if (percent1 <= 30)
{
    var position = animcurve_channel_evaluate(curvelinear, percent1 / 20);
    var position2 = animcurve_channel_evaluate(curveease, percent1 / 30);
    speedx = lerp(-4, 6 + randomadd, position);
