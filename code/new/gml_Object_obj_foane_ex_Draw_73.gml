...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 18;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_0"), 25);
            typing_speed = 1;
            break;
        case 2:
            susietalk = false;
            ...
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        case 3:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_2"), 31);
            typing_speed = 1;
            break;
        case 4:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_3"), 31);
            typing_speed = 1;
            break;
        case 5:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_4"), 31);
            typing_speed = 1;
            break;
        case 6:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_5"), 31);
            typing_speed = 1;
            break;
        case 7:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_6"), 31);
            typing_speed = 1;
            break;
        case 8:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_7"), 31);
            typing_speed = 1;
            break;
        case 9:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 27;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_8"), 25);
            typing_speed = 1;
            break;
        case 10:
            susietalk = false;
            emptytalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_9"), 31);
            typing_speed = 1/3;
        ...
        case 11:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_10"), 31);
            typing_speed = 1;
            break;
        case 12:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_11"), 31);
            typing_speed = 1;
            break;
        case 13:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_12"), 31);
            typing_speed = 1;
        ...
        case 14:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_13"), 31);
            typing_speed = 1;
            break;
        case 15:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_14"), 31);
            typing_speed = 1;
        ...
        case 16:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = translation_get_string("gml_Object_obj_foane_ex_Draw_73_15");
            typing_speed = 1;
            break;
        case 17:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 19;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_16"), 25);
            typing_speed = 1;
            break;
        case 18:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 35;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_17"), 25);
            typing_speed = 1;
            break;
        case 19:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 18;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_18"), 25);
            typing_speed = 1;
            image_index = 2;
            break;
        case 20:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_19"), 31);
            typing_speed = 1;
            break;
        case 21:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_20"), 31);
            typing_speed = 1;
            break;
        case 22:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_21"), 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 23:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_22"), 31);
            typing_speed = 1;
            break;
        case 24:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_23"), 31);
            typing_speed = 1;
            image_index = 2;
            break;
        case 25:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_24"), 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 26:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_25"), 31);
            typing_speed = 1;
            break;
        case 27:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_26"), 31);
            typing_speed = 1;
            image_index = 0;
        ...
        case 28:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_27"), 31);
            typing_speed = 1;
            break;
        case 29:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_28"), 31);
            typing_speed = 1;
            break;
        case 30:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_29"), 31);
            typing_speed = 1;
            image_index = 0;
            break;
        case 31:
            ...
            dialogueicon = 34;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_30"), 25);
            typing_speed = 1;
            break;
        case 32:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_31"), 31);
            typing_speed = 1;
            break;
        case 33:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_32"), 31);
            typing_speed = 1;
            break;
        case 34:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_33"), 31);
            typing_speed = 1;
            sprite_index = spr_foane_ex_raise;
            image_index = 3;
            break;
        case 35:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_34"), 31);
            typing_speed = 1;
        ...
        case 36:
            ...
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_35"), 31);
            typing_speed = 1;
            break;
        case 37:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_36"), 31);
            typing_speed = 1;
            break;
        case 38:
            ralseitalk = true;
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 35;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_37"), 25);
            typing_speed = 1;
            break;
        case 39:
            ralseitalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_ex_Draw_73_38"), 31);
            typing_speed = 1;
            ...
            break;
        default:
            current_dialogue = translation_get_string("gml_Object_obj_foane_ex_Draw_73_39");
            break;
    }
    ...
    if (!text_complete && !pause_for_punctuation)
    {
        ...
        while (typing_timer >= 1)
        {
            ...
            if (letter_index < string_length(current_dialogue))
            {
                ...
                var following_char = ((letter_index + 2) <= string_length(current_dialogue)) ? string_char_at(current_dialogue, letter_index + 2) : translation_get_string("gml_Object_obj_foane_ex_Draw_73_40");
    ...
    if (dialogue == 4)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_ex_Draw_73_41"));
        var x_offset = text_x;
        var y_offset = text_y;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_ex_Draw_73_42"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_ex_Draw_73_43"), remaining) > 0)
                {
                    x_offset = text_x;
    ...
    if (dialogue == 12)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_ex_Draw_73_44"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_ex_Draw_73_45"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_ex_Draw_73_46"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
    ...
    if (dialogue == 16)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_ex_Draw_73_47"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_ex_Draw_73_48"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_ex_Draw_73_49"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
    ...
    if (dialogue == 23)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_ex_Draw_73_50"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_ex_Draw_73_51"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_ex_Draw_73_52"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
    ...
    if (dialogue == 26)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_ex_Draw_73_53"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_ex_Draw_73_54"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_ex_Draw_73_55"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
