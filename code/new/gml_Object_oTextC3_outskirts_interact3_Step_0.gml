...
switch (dialogue)
{
    case 1:
        ...
        if (!global.morehungry)
            current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_0");
        else
            current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_1");
    ...
    case 2:
        ...
        current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_2");
        typing_speed = 1;
        oDialogueSprite.image_index = 10;
        break;
    case 3:
        global.susietalk = true;
        current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_3");
        typing_speed = 1;
    ...
    case 4:
        global.susietalk = true;
        current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_4");
        typing_speed = 1;
        oDialogueSprite.image_index = 17;
        oSusieC3.sprite_index = sSusieWalkDown;
        break;
    ...
    case 10:
        ...
        break;
    default:
        current_dialogue = translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_5");
        break;
}
...
if (!text_complete && !pause_for_punctuation)
{
    ...
    while (typing_timer >= 1)
    {
        ...
        if (letter_index < string_length(current_dialogue))
        {
            ...
            var following_char = ((letter_index + 2) <= string_length(current_dialogue)) ? string_char_at(current_dialogue, letter_index + 2) : translation_get_string("gml_Object_oTextC3_outskirts_interact3_Step_0_6");
