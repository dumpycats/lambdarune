...
switch (dialogue)
{
    case 1:
        ...
        {
            current_dialogue = string(dialogue_to_display);
        ...
        else
        {
            ...
            {
                case 1:
                    current_dialogue = translation_get_string("oTextC3_kreid_interact1_Step_0_0");
                    break;
                case 2:
                    current_dialogue = translation_get_string("oTextC3_kreid_interact1_Step_0_1");
                    break;
                case 3:
                    current_dialogue = translation_get_string("oTextC3_kreid_interact1_Step_0_2");
                    break;
            }
        }
    ...
    case 2:
        global.texttalk = true;
        current_dialogue = string(dialogue_to_display2);
        typing_speed = 1;
        break;
    case 3:
        global.texttalk = true;
        current_dialogue = string(dialogue_to_display3);
        typing_speed = 1;
        break;
    case 4:
        global.texttalk = true;
...
{
    blockprogress = true;
    obj_kreid_interactable.timer = -2;
