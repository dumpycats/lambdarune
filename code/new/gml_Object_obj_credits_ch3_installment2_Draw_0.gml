...
if (percent1 <= 2770)
{
    hold = (keyboard_check(ord("Z")) || keyboard_check(vk_enter)) || (keyboard_check(ord(translation_get_string("obj_credits_ch3_installment2_Draw_0_0"))) || keyboard_check(vk_shift));
}
else
{
