...
{
    var text_parts = string_split(global.current_dialogue, lang("oTextC3_spacechannel5_Draw_0_0"));
    var x_offset = text_x;
    var y_offset = text_y;
    ...
    for (var i = 0; i < array_length(text_parts); i++)
    {
        ...
        var lines = string_split(part, lang("oTextC3_spacechannel5_Draw_0_1"));
        ...
        if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
        {
            ...
            if (string_pos(lang("oTextC3_spacechannel5_Draw_0_2"), remaining) > 0)
            {
                x_offset = text_x;
    ...
    if (string_length(global.displayed_text) == string_length(global.current_dialogue))
    {
        ...
        if (last_char == lang("oTextC3_spacechannel5_Draw_0_3"))
        {
            draw_set_color(#320032);
            draw_text((x_offset + 1) - 16, y_offset + 1, lang("oTextC3_spacechannel5_Draw_0_4"));
            draw_set_color(color6);
            draw_text(x_offset - 16, y_offset, lang("oTextC3_spacechannel5_Draw_0_5"));
        }
    }
