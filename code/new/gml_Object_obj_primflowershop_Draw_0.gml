...
if (buymenu)
{
    ...
    if (buyoptions == 0)
        draw_text(440, 231 + yoffset, translation_get_string("obj_primflowershop_Draw_0_0"));
    
    if (buyoptions == 1)
    {
        draw_text(440, 231 + yoffset, translation_get_string("obj_primflowershop_Draw_0_1"));
        draw_sprite_ext(spr_primshop_armor, 0, 320, 240 + yoffset + 180, 1, 1, 0, c_white, 1);
    }
    
    if (buyoptions == 2)
        draw_text(440, 231 + yoffset, translation_get_string("obj_primflowershop_Draw_0_2"));
    
    if (buyoptions == 3)
    {
        draw_text(440, 231 + yoffset, translation_get_string("obj_primflowershop_Draw_0_3"));
...
if (buymenu)
{
    ...
    if (!teabought)
    {
        draw_text(60, 264, translation_get_string("obj_primflowershop_Draw_0_4"));
        draw_text(300, 264, translation_get_string("obj_primflowershop_Draw_0_5"));
    }
    else
    {
        draw_text_color(60, 264, translation_get_string("obj_primflowershop_Draw_0_6"), c_gray, c_gray, c_gray, c_gray, 1);
    }
    
    draw_text(60, 304, translation_get_string("obj_primflowershop_Draw_0_7"));
    draw_text(300, 304, translation_get_string("obj_primflowershop_Draw_0_8"));
    draw_text(60, 344, translation_get_string("obj_primflowershop_Draw_0_9"));
    draw_text(300, 344, translation_get_string("obj_primflowershop_Draw_0_10"));
    draw_text(60, 384, translation_get_string("obj_primflowershop_Draw_0_11"));
    draw_text(300, 384, translation_get_string("obj_primflowershop_Draw_0_12"));
    draw_text(60, 424, translation_get_string("obj_primflowershop_Draw_0_13"));
    ...
    if (selectedbuy)
    {
        ...
        draw_text(480, 343, translation_get_string("obj_primflowershop_Draw_0_14"));
        ...
        if (buyoptions == 0)
            draw_text(460, 263, translation_get_string("obj_primflowershop_Draw_0_15"));
        else if (buyoptions == 1)
            draw_text(460, 263, translation_get_string("obj_primflowershop_Draw_0_16"));
        else if (buyoptions == 2)
            draw_text(460, 263, translation_get_string("obj_primflowershop_Draw_0_17"));
        else if (buyoptions == 3)
            draw_text(460, 263, translation_get_string("obj_primflowershop_Draw_0_18"));
    }
    ...
    if (space > 0)
        text = translation_get_string("obj_primflowershop_Draw_0_19") + string(space);
    else
        text = translation_get_string("obj_primflowershop_Draw_0_20");
...
if (mainmenu)
{
    ...
    draw_text_with_tracking(480, 264, translation_get_string("obj_primflowershop_Draw_0_21"), 16777215, 0, 8);
    yoffset = 0;
    percentbuy = 0;
...
{
    draw_set_font(fDeterminationSans);
    draw_text_with_tracking(440, 424, translation_get_string("obj_primflowershop_Draw_0_22") + string(global.money), 16777215, 0, 7);
}
...
if (talkmenu)
{
    ...
    if (!yourselftalked)
        draw_text(80, 264, translation_get_string("obj_primflowershop_Draw_0_23"));
    else
        draw_text_color(80, 264, translation_get_string("obj_primflowershop_Draw_0_24"), c_yellow, c_yellow, c_yellow, c_yellow, 1);
    
    draw_text(80, 304, translation_get_string("obj_primflowershop_Draw_0_25"));
    draw_text(80, 344, translation_get_string("obj_primflowershop_Draw_0_26"));
    
    if (!freedomtalked)
        draw_text(80, 384, translation_get_string("obj_primflowershop_Draw_0_27"));
    else
        draw_text_color(80, 384, translation_get_string("obj_primflowershop_Draw_0_28"), c_yellow, c_yellow, c_yellow, c_yellow, 1);
    
    draw_text(80, 424, translation_get_string("obj_primflowershop_Draw_0_29"));
