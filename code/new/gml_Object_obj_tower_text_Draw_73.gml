...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 2:
            ...
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_0"), 31);
            dialogueicon = 0;
            typing_speed = 1;
        ...
        case 3:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_1"), 25);
            dialogueicon = 7;
            typing_speed = 1;
            break;
        case 4:
            ...
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_2"), 25);
            dialogueicon = 20;
            typing_speed = 1;
            break;
        case 5:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_3"), 25);
            dialogueicon = 17;
            typing_speed = 1;
            break;
        case 6:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_4"), 25);
            dialogueicon = 26;
            typing_speed = 1;
            break;
        case 7:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_5"), 25);
            dialogueicon = 17;
            typing_speed = 1;
            break;
        case 8:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_6"), 25);
            dialogueicon = 10;
            typing_speed = 1;
            break;
        case 9:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_7"), 25);
            dialogueicon = 9;
            typing_speed = 1;
            break;
        case 10:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_8"), 25);
            dialogueicon = 2;
            typing_speed = 1;
            break;
        case 11:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_9"), 25);
            dialogueicon = 26;
            typing_speed = 1;
        ...
        case 12:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_10"), 25);
            dialogueicon = 5;
            typing_speed = 1;
        ...
        case 13:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_11"), 25);
            dialogueicon = 5;
            typing_speed = 1;
        ...
        case 14:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_12"), 25);
            dialogueicon = 22;
            typing_speed = 1;
        ...
        case 15:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_13"), 25);
            dialogueicon = 7;
            typing_speed = 1;
        ...
        case 16:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_14"), 25);
            dialogueicon = 25;
            typing_speed = 1;
        ...
        case 17:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_15"), 25);
            dialogueicon = 21;
            typing_speed = 1;
        ...
        case 18:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_16"), 25);
            dialogueicon = 15;
            typing_speed = 0.5;
        ...
        case 19:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_17"), 25);
            dialogueicon = 27;
            typing_speed = 1;
            break;
        case 20:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_18"), 25);
            dialogueicon = 24;
            typing_speed = 1;
            break;
        case 21:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_19"), 25);
            dialogueicon = 25;
            typing_speed = 1;
            break;
        case 22:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_20"), 25);
            dialogueicon = 3;
            typing_speed = 1;
        ...
        case 23:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_21"), 25);
            dialogueicon = 2;
            typing_speed = 1;
            break;
        case 24:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_22"), 25);
            dialogueicon = 13;
            typing_speed = 1;
            SUSIE.sprite_index = sSusieWalkDownUpset;
            break;
        case 25:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_23"), 25);
            dialogueicon = 21;
            typing_speed = 1;
            SUSIE.sprite_index = sSusieWalkLeft;
        ...
        case 26:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_24"), 25);
            dialogueicon = 9;
            typing_speed = 1;
            break;
        case 27:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_25"), 25);
            dialogueicon = 5;
            typing_speed = 1;
            break;
        case 28:
            ...
            ralseitalk = true;
            dialogueiconchoice = sRalseiDialogueSprite;
            current_dialogue = format_text(translation_get_string("obj_tower_text_Draw_73_26"), 25);
            dialogueicon = 26;
            typing_speed = 1;
