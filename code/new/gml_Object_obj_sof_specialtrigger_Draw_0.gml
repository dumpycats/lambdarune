...
draw_text(cx + 318, cy + 50, lang("obj_sof_specialtrigger_Draw_0_0"));
draw_text(cx + 322, cy + 50, lang("obj_sof_specialtrigger_Draw_0_1"));
draw_text(cx + 320, cy + 48, lang("obj_sof_specialtrigger_Draw_0_2"));
draw_text(cx + 320, cy + 52, lang("obj_sof_specialtrigger_Draw_0_3"));
draw_set_color(c_white);
draw_text(cx + 320, cy + 50, lang("obj_sof_specialtrigger_Draw_0_4"));
