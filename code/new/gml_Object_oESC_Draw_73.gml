...
if (debugfps)
{
    ...
    var fpscounter = get_lang_string("oESC_Draw_73_0") + string(round(fps_real));
...
if (crttrigger)
{
    ...
    {
        var warning = get_lang_string("oESC_Draw_73_1");
    ...
    {
        var warning = get_lang_string("oESC_Draw_73_2");
        draw_text(cx + 320, cy + 48 + 2, warning);
        draw_text(cx + 320, (cy + 48) - 2, warning);
        draw_text(cx + 320 + 2, cy + 48, warning);
        draw_text((cx + 320) - 2, cy + 48, warning);
