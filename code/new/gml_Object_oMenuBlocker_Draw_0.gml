if (global.shoptalkmenu && !global.shopmainmenu && !global.shopbuymenu)
{
    if (global.midnightcrewoption)
        text = translation_get_string("gml_Object_oMenuBlocker_Draw_0_0");
    else
        text = translation_get_string("gml_Object_oMenuBlocker_Draw_0_1");
    ...
    for (var i = 1; i <= string_length(text); i++)
    {
        ...
        if (current_char == translation_get_string("gml_Object_oMenuBlocker_Draw_0_2"))
        {
            text_x = 58;
...
if (global.shoptalkmenu && !global.shopmainmenu && !global.shopbuymenu)
{
    if (global.revengeoption)
        text2 = translation_get_string("gml_Object_oMenuBlocker_Draw_0_3");
    else
        text2 = translation_get_string("gml_Object_oMenuBlocker_Draw_0_4");
    ...
    for (var i = 1; i <= string_length(text2); i++)
    {
        ...
        if (current_char2 == translation_get_string("gml_Object_oMenuBlocker_Draw_0_5"))
        {
            text_x2 = 58;
...
if (global.shoptalkmenu && !global.shopmainmenu && !global.shopbuymenu)
{
    if (global.cathodecrewoption)
        text3 = translation_get_string("gml_Object_oMenuBlocker_Draw_0_6");
    else
        text3 = translation_get_string("gml_Object_oMenuBlocker_Draw_0_7");
    ...
    for (var i = 1; i <= string_length(text3); i++)
    {
        ...
        if (current_char3 == translation_get_string("gml_Object_oMenuBlocker_Draw_0_8"))
        {
            text_x3 = 58;
