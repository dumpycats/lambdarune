...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_0"), 31);
            typing_speed = 1;
            break;
        case 2:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        case 3:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_2"), 31);
            typing_speed = 1;
            break;
        case 4:
            window_set_caption(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_3"));
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_4"), 31);
            typing_speed = 0.5;
            blockprogress = true;
            dsongtrigger = true;
        ...
        case 5:
            ...
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_5"), 31);
            typing_speed = 0.5;
            break;
        case 6:
            foanetalk = false;
            reverbtalk = true;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_6"), 31);
            typing_speed = 0.5;
            break;
        case 7:
            foanetalk = true;
            reverbtalk = false;
            charactertalking = false;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_7"), 31);
            typing_speed = 2/3;
            blockprogress = false;
        ...
        case 8:
            ...
            charactertalking = false;
            textxoffset = -26;
            current_dialogue = translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_8");
            typing_speed = 1;
            break;
        case 9:
            foanetalk = false;
            ...
            textxoffset = 150;
            charactertalking = false;
            current_dialogue = translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_9");
            typing_speed = 1;
            break;
        default:
            current_dialogue = translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_10");
            break;
    }
    ...
    if (!text_complete && !pause_for_punctuation)
    {
        ...
        while (typing_timer >= 1)
        {
            ...
            if (letter_index < string_length(current_dialogue))
            {
                ...
                var following_char = ((letter_index + 2) <= string_length(current_dialogue)) ? string_char_at(current_dialogue, letter_index + 2) : translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_11");
    ...
    if (dialogue == 2)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_12"));
        var x_offset = text_x;
        var y_offset = text_y;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_13"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_14"), remaining) > 0)
                {
                    x_offset = text_x;
    ...
    if (dialogue == 6)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_15"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_16"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_17"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
    ...
    if (dialogue == 8)
    {
        var text_parts = string_split(current_dialogue, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_18"));
        var x_offset = text_x;
        var y_offset = text_y;
        var current_displayed = displayed_text;
        ...
        for (var i = 0; i < array_length(text_parts); i++)
        {
            ...
            var lines = string_split(part, translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_19"));
            ...
            if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
            {
                ...
                if (string_pos(translation_get_string("gml_Object_obj_foane_pretalk_1_Draw_73_20"), remaining) > 0)
                {
                    x_offset = text_x;
                    y_offset += string_height(remaining);
                }
