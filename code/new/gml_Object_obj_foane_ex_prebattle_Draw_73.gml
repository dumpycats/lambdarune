...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_0"), 31);
            typing_speed = 1;
            break;
        case 2:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        case 3:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_2"), 31);
            typing_speed = 1;
            break;
        case 4:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_3"), 31);
            typing_speed = 1;
            break;
        case 5:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_4"), 31);
            typing_speed = 1;
            break;
        case 6:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_5"), 31);
            typing_speed = 1;
            break;
        case 7:
            susietalk = false;
            foanetalk = true;
            charactertalking = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_6"), 31);
            typing_speed = 1;
            
            if (displayed_text >= format_text("It will be mine to taketaketaketaketaketake!", 31))
            {
                var extradialogue = get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_7");
    ...
    if (dialogue == 7)
    {
        var text_parts = string_split(current_dialogue, get_lang_string("gml_Object_obj_foane_ex_prebattle_Draw_73_8"));
        var x_offset = text_x;
        var y_offset = text_y;
    ...
    if ((advance_pressed && !blockprogress) || skiptimer == 2)
    {
        ...
        if (text_complete)
        {
            ...
            {
                if (dialogue == 1)
                    obj_kris_sof.falldown = true;
                
                if (dialogue == 6)
                    obj_kris_sof.timertrigger2 = true;
                
                if (dialogue == 7)
                {
                    obj_foane_ex_battle.image_speed = 1;
                    audio_stop_sound(mus_wind);
                    audio_play_sound(snd_petrify, 1, false, 1, false, 0.9);
                    obj_kris_sof.timertrigger3 = true;
                }
