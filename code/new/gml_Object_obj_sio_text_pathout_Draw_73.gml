...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 2;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_0"), 25);
            typing_speed = 1;
        ...
        case 2:
            ...
            dialogueicon = 17;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_1"), 25);
            typing_speed = 1;
            break;
        case 3:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 10;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_2"), 25);
            typing_speed = 1;
            break;
        case 4:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 1;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_3"), 25);
            typing_speed = 1;
        ...
        case 5:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_4"), 25);
        ...
        case 6:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 4;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_5"), 25);
            typing_speed = 1;
        ...
        case 7:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 12;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_6"), 25);
            typing_speed = 1;
        ...
        case 8:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 26;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_7"), 25);
            typing_speed = 1;
            obj_susie_sio.sprite_index = sSusieWalkUp;
        ...
        case 9:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 11;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_8"), 25);
            typing_speed = 1;
            break;
        case 10:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 13;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_9"), 25);
            typing_speed = 1;
            break;
        case 11:
            susietalk = false;
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_10"), 25);
            typing_speed = 1;
            break;
        case 12:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 26;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_11"), 25);
            typing_speed = 1;
        ...
        case 13:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 5;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_12"), 25);
            typing_speed = 1;
            obj_susie_sio.sprite_index = sSusieWalkDown;
            obj_susie_sio.image_speed = 0;
            obj_susie_sio.image_index = 0;
        ...
        case 14:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 2;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_13"), 25);
            typing_speed = 1;
            break;
        case 15:
            susietalk = false;
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 18;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_14"), 25);
            typing_speed = 1;
            obj_susie_sio.sprite_index = sSusieWalkUp;
            obj_susie_sio.image_speed = 0;
            obj_susie_sio.image_index = 0;
        ...
        case 16:
            ...
            dialogueiconchoice = sRalseiDialogueSprite;
            dialogueicon = 26;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_15"), 25);
            typing_speed = 1;
            break;
        case 17:
            susietalk = true;
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 10;
            current_dialogue = format_text(get_lang_string("obj_sio_text_pathout_Draw_73_16"), 25);
            typing_speed = 1;
            endcase1 = dialogue;
            break;
        default:
