...
if (instance_exists(ENGINE))
{
    ...
    else if (((global.enemyturn || ENGINE.textenemy) && !manualoff) || ENGINE.finaltalktimer >= 300)
    {
...
if (flashtrigger)
{
    ...
    if (flashpercent == 0.1)
    {
        ...
        if (instance_exists(ENGINE))
        {
            ...
            if ((itemchoice + global.krishp) > 0 && global.krishp <= 0)
                greenhp.up = true;
            
            global.krishp += itemchoice;
