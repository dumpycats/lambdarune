...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_0"), 25);
            typing_speed = 1;
        ...
        case 2:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_1"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 6;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_2"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            break;
        case 4:
            texttalk = false;
            susietalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_3"), 25);
            typing_speed = 1;
        ...
        case 5:
            susietalk = false;
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_4"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 0;
            break;
        case 6:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_5"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            break;
        case 7:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_6"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 1;
            break;
        case 8:
            texttalk = false;
            ralseitalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_7"), 25);
            typing_speed = 1;
        ...
        case 9:
            texttalk = true;
            ralseitalk = false;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_8"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            break;
        case 10:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_9"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 5;
            break;
        case 11:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_10"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            break;
        case 12:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_11"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 3;
            break;
        ...
        case 14:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_12"), 25);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 6;
            break;
        case 15:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_13"), 25);
            typing_speed = 1;
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 13;
            break;
        case 16:
            ...
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_14"), 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 17:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_15"), 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 18:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_16"), 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            break;
        case 19:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_17"), 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            image_index = 1;
        ...
        case 20:
            texttalk = false;
            emptytalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_tenna_sof_Draw_73_18"), 31);
            typing_speed = 1;
            dialogueiconchoice = sTennaDialogueSprite;
            dialogueicon = 9;
            image_index = 2;
