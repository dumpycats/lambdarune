...
{
    var text_parts = string_split(global.current_dialogue, translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_0"));
    var x_offset = text_x;
    var y_offset = text_y;
    ...
    for (var i = 0; i < array_length(text_parts); i++)
    {
        ...
        var lines = string_split(part, translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_1"));
        ...
        if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
        {
            ...
            if (string_pos(translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_2"), remaining) > 0)
            {
                x_offset = text_x;
...
{
    var text_parts = string_split(global.current_dialogue, translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_3"));
    var x_offset = text_x;
    var y_offset = text_y;
    var current_displayed = global.displayed_text;
    ...
    for (var i = 0; i < array_length(text_parts); i++)
    {
        ...
        var lines = string_split(part, translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_4"));
        ...
        if (i < (array_length(text_parts) - 1) && string_length(current_displayed) > 0)
        {
            ...
            if (string_pos(translation_get_string("gml_Object_oTextC3_spacechannel2_Draw_0_5"), remaining) > 0)
            {
                x_offset = text_x;
                y_offset += string_height(remaining);
            }
