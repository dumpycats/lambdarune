...
{
    var text_parts = string_split(global.current_dialogue, translation_get_string("oTextC3_spacechannel2_Draw_0_0"));
    var x_offset = text_x;
    var y_offset = text_y;
...
{
    var text_parts = string_split(global.current_dialogue, translation_get_string("oTextC3_spacechannel2_Draw_0_1"));
    var x_offset = text_x;
    var y_offset = text_y;
    var current_displayed = global.displayed_text;
