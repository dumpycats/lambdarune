...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("obj_sio_screenshow_2_Draw_73_0"), 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("obj_sio_screenshow_2_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("obj_sio_screenshow_2_Draw_73_2"), 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
