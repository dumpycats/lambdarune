...
var textt = get_lang_string("oDebugText_Draw_0_0");
var text_xt = 20;
var text_yt = 20;
...
{
    var text = get_lang_string("oDebugText_Draw_0_1");
    var text_x = 20;
    var text_y = 20;
...
{
    var text2 = get_lang_string("oDebugText_Draw_0_2");
    var text_x2 = 20;
    var text_y2 = 50;
...
{
    var text3 = get_lang_string("oDebugText_Draw_0_3");
    var text_x3 = 20;
    var text_y3 = 80;
...
{
    var text4 = get_lang_string("oDebugText_Draw_0_4");
    var text_x4 = 20;
    var text_y4 = 110;
...
{
    var text5 = get_lang_string("oDebugText_Draw_0_5");
    var text_x5 = 20;
    var text_y5 = 140;
