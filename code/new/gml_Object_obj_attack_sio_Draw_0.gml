...
if (timer == 1)
{
    ...
    if (kris)
        array_push(active_members, translation_get_string("gml_Object_obj_attack_sio_Draw_0_0"));
    
    if (susie)
        array_push(active_members, translation_get_string("gml_Object_obj_attack_sio_Draw_0_1"));
    
    if (ralsei)
        array_push(active_members, translation_get_string("gml_Object_obj_attack_sio_Draw_0_2"));
    ...
    if (krishit)
    {
        ...
        if (krishittimer == 12)
        {
            ...
            if (!krismiss)
            {
                ...
                obj_maximike_battle.hitnoise = true;
                obj_maximike_battle.hitoffset = 0;
                obj_maximike_battle.noiseoffset = 0;
                ...
                obj_maximike_channel.sprite_index = spr_maximike_hurt;
            }
        }
    ...
    if (susiehit)
    {
        ...
        if (susiehittimer == 12)
        {
            ...
            if (!susiemiss)
            {
                ...
                audio_play_sound(snd_damage, 1, false);
                obj_maximike_battle.hitnoise = true;
                obj_maximike_battle.hitoffset = -0.3;
                obj_maximike_battle.noiseoffset = 0;
    ...
    if (ralseihit)
    {
        ...
        if (ralseihittimer == 12)
        {
            ...
            if (!ralseimiss)
            {
                ...
                audio_play_sound(snd_damage, 1, false);
                obj_maximike_battle.hitnoise = true;
                obj_maximike_battle.hitoffset = 0.2;
                obj_maximike_battle.noiseoffset = 0;
