...
switch (global.dialogue)
{
    case 1:
        ...
        if (!global.missedopportunity)
            global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_0");
        else
    ...
    case 2:
        ...
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_1");
        global.typing_speed = 1;
        obj_foane_spacechannel.image_index = 2;
        d2timer++;
    ...
    case 4:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_2");
        global.typing_speed = 1;
    ...
    case 5:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_3");
        global.typing_speed = 1;
        audio_sound_pitch(snd_foane, 1);
        obj_foane_spacechannel.image_index = 0;
        obj_foane_spacechannel.image_speed = 0;
    ...
    case 6:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_4");
        global.typing_speed = 1;
    ...
    case 7:
        ...
        fo = true;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_5");
        global.typing_speed = 1;
        obj_foane_spacechannel.image_index = 0;
        obj_foane_spacechannel.image_speed = 0;
        break;
    case 8:
        ...
        fo = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("gml_Object_oTextC3_spacechannel5_Step_0_6");
        global.typing_speed = 1;
