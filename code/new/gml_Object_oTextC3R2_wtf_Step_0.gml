...
switch (global.wtfdialogue)
{
    case 1:
        global.susietalk = true;
        global.charactertalking = true;
        global.current_dialogue = translation_get_string("gml_Object_oTextC3R2_wtf_Step_0_0");
    ...
    case 400:
        ...
        global.charactertalking = true;
        global.current_dialogue = translation_get_string("gml_Object_oTextC3R2_wtf_Step_0_1");
        ...
        break;
    default:
        global.current_dialogue = translation_get_string("gml_Object_oTextC3R2_wtf_Step_0_2");
        break;
}
...
if (!global.text_complete && !global.pause_for_punctuation)
{
    ...
    while (global.typing_timer >= 1)
    {
        ...
        if (global.letter_index < string_length(global.current_dialogue))
        {
            ...
            var following_char = ((global.letter_index + 2) <= string_length(global.current_dialogue)) ? string_char_at(global.current_dialogue, global.letter_index + 2) : translation_get_string("gml_Object_oTextC3R2_wtf_Step_0_3");
