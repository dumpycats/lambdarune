...
switch (dialogue)
{
    case 1:
        ...
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_0");
    ...
    case 2:
        ...
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_1");
        global.typing_speed = 1;
        break;
    case 3:
        global.foanetalk = true;
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_2");
        global.typing_speed = 1;
        break;
    case 4:
        global.foanetalk = true;
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_3");
        global.typing_speed = 1;
        audio_sound_pitch(snd_foane, 1);
        break;
    case 5:
        ...
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_4");
        global.typing_speed = 1;
        break;
    case 6:
        global.foanetalk = true;
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_5");
        global.typing_speed = 1;
        break;
    case 7:
        global.foanetalk = true;
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_6");
        global.typing_speed = 1;
        break;
    case 8:
        global.foanetalk = true;
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_7");
        global.typing_speed = 1;
        audio_sound_pitch(snd_foane, 1);
        window_set_caption("");
        break;
    case 9:
        ...
        global.texttalk = false;
        global.charactertalking = false;
        global.current_dialogue = get_lang_string("oTextC3_spacechannel6_Step_0_8");
        global.typing_speed = 1;
        break;
    case 10:
