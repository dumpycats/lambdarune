...
{
    window_set_caption(translation_get_string("gml_Object_oGlobalC3Room_credits_Create_0_0"));
...
{
    window_set_caption(translation_get_string("gml_Object_oGlobalC3Room_credits_Create_0_1"));
...
if (room == rm_ch3_promo)
    window_set_caption(translation_get_string("gml_Object_oGlobalC3Room_credits_Create_0_2"));
