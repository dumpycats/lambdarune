...
switch (global.dialogue)
{
    case 1:
        ...
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_0");
    ...
    case 2:
        ...
        global.charactertalking = false;
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_1");
        global.typing_speed = 1;
        break;
    case 3:
        global.foanetalk = true;
        global.feighlinetalk = false;
        global.charactertalking = false;
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_2");
        global.typing_speed = 1;
        break;
    case 4:
        ...
        global.foanetalk = false;
        global.charactertalking = false;
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_3");
        global.typing_speed = 1;
    ...
    case 280:
        global.emptytalk = true;
        global.charactertalking = false;
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_4");
        global.typing_speed = 1;
        blockprogress = true;
        instance_destroy(oDialogueSprite);
        instance_destroy(oDialogueBox);
        ...
        break;
    default:
        global.current_dialogue = lang("oTextC3_spacechannel1_Step_0_5");
        break;
}
...
if (!global.text_complete && !global.pause_for_punctuation)
{
    ...
    while (global.typing_timer >= 1)
    {
        ...
        if (global.letter_index < string_length(global.current_dialogue))
        {
            ...
            var following_char = ((global.letter_index + 2) <= string_length(global.current_dialogue)) ? string_char_at(global.current_dialogue, global.letter_index + 2) : lang("oTextC3_spacechannel1_Step_0_6");
