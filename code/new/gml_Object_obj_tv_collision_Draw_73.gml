...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_0"), 31);
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_2"), 31);
            typing_speed = 1;
            break;
        case 4:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_3"), 31);
            typing_speed = 1;
            break;
        case 5:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_4"), 31);
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
            current_dialogue = format_text(translation_get_string("gml_Object_obj_tv_collision_Draw_73_5"), 31);
            typing_speed = 1;
            break;
        case 7:
            texttalk = true;
            current_dialogue = translation_get_string("gml_Object_obj_tv_collision_Draw_73_6");
            typing_speed = 1;
            break;
        case 8:
            texttalk = true;
            current_dialogue = translation_get_string("gml_Object_obj_tv_collision_Draw_73_7");
            typing_speed = 1;
            break;
        case 9:
            texttalk = true;
            current_dialogue = translation_get_string("gml_Object_obj_tv_collision_Draw_73_8");
            typing_speed = 1;
            break;
        case 10:
            texttalk = true;
            current_dialogue = translation_get_string("gml_Object_obj_tv_collision_Draw_73_9");
            typing_speed = 1;
            break;
        default:
            current_dialogue = translation_get_string("gml_Object_obj_tv_collision_Draw_73_10");
            break;
    }
    ...
    if (!text_complete && !pause_for_punctuation)
    {
        ...
        while (typing_timer >= 1)
        {
            ...
            if (letter_index < string_length(current_dialogue))
            {
                ...
                var following_char = ((letter_index + 2) <= string_length(current_dialogue)) ? string_char_at(current_dialogue, letter_index + 2) : translation_get_string("gml_Object_obj_tv_collision_Draw_73_11");
