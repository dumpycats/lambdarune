    ...
    else if (krisselected)
    {
        ...
        if (krismenuoptions == 1 || krismenuoptions == 2 || krismenuoptions == 4)
        {
            if (!krisactselected)
            {
                ...
                draw_text(cx + 80, cy + 379, translation_get_string("obj_battle_kf_Draw_0_0"));
                draw_text_transformed(cx + 424, cy + 366, translation_get_string("obj_battle_kf_Draw_0_1"), 1, 0.5, 0);
                draw_text_transformed(cx + 524, cy + 366, translation_get_string("obj_battle_kf_Draw_0_2"), 1, 0.5, 0);
            ...
            if (krismenuoptions == 2)
            {
                ...
                else if (krisactselected)
                {
                    ...
                    draw_text(cx + 80, cy + 379, translation_get_string("obj_battle_kf_Draw_0_3"));
                    
                    if (global.turn > 7)
                        draw_text(cx + 310, cy + 379, translation_get_string("obj_battle_kf_Draw_0_4"));
                    else
                        draw_text(cx + 310, cy + 379, translation_get_string("obj_battle_kf_Draw_0_5"));
        ...
        if (krismenuoptions == 3 && !(advancecounter >= 12))
        {
            ...
            ds_map_add(item_name_map, krispykreid, translation_get_string("obj_battle_kf_Draw_0_6"));
            ds_map_add(item_name_map, shadowdonut, translation_get_string("obj_battle_kf_Draw_0_7"));
            ds_map_add(item_name_map, adultsoda, translation_get_string("obj_battle_kf_Draw_0_8"));
            ds_map_add(item_name_map, shotglass, translation_get_string("obj_battle_kf_Draw_0_9"));
            ds_map_add(item_name_map, puffpastry, translation_get_string("obj_battle_kf_Draw_0_10"));
            ds_map_add(item_name_map, spincake, translation_get_string("obj_battle_kf_Draw_0_11"));
            ds_map_add(item_name_map, rottentea, translation_get_string("obj_battle_kf_Draw_0_12"));
            ds_map_add(item_name_map, craftyglue, translation_get_string("obj_battle_kf_Draw_0_13"));
            ds_map_add(item_name_map, empty, "");
            var item_hover_map = ds_map_create();
            ds_map_add(item_hover_map, krispykreid, translation_get_string("obj_battle_kf_Draw_0_14"));
            ds_map_add(item_hover_map, shadowdonut, translation_get_string("obj_battle_kf_Draw_0_15"));
            ds_map_add(item_hover_map, adultsoda, translation_get_string("obj_battle_kf_Draw_0_16"));
            ds_map_add(item_hover_map, shotglass, translation_get_string("obj_battle_kf_Draw_0_17"));
            ds_map_add(item_hover_map, puffpastry, translation_get_string("obj_battle_kf_Draw_0_18"));
            ds_map_add(item_hover_map, spincake, translation_get_string("obj_battle_kf_Draw_0_19"));
            ds_map_add(item_hover_map, rottentea, translation_get_string("obj_battle_kf_Draw_0_20"));
            ds_map_add(item_hover_map, craftyglue, translation_get_string("obj_battle_kf_Draw_0_21"));
