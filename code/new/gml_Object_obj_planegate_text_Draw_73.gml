...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            dialogueicon = 11;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_0"), 25);
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_1"), 25);
            typing_speed = 1;
            dialogueicon = 12;
        ...
        case 3:
            ...
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_2"), 25);
            dialogueicon = 9;
            typing_speed = 1;
            break;
        case 4:
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_3"), 25);
            typing_speed = 1;
            dialogueicon = 10;
            break;
        case 5:
            ...
            dialogueiconchoice = sSusieDialogueSprite;
            dialogueicon = 3;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_4"), 25);
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_planegate_text_Draw_73_5"), 31);
            typing_speed = 1;
            break;
        case 7:
            texttalk = true;
