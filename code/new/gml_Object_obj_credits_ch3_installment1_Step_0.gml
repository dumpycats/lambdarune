...
var advance_held = keyboard_check_direct(vk_enter) || keyboard_check_direct(ord("Z")) || (keyboard_check_direct(vk_shift) || keyboard_check_direct(ord(translation_get_string("gml_Object_obj_credits_ch3_installment1_Step_0_0"))));
