...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_egg_ch3_Draw_73_0"), 31);
            typing_speed = 1;
            break;
        case 2:
            texttalk = true;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_egg_ch3_Draw_73_1"), 31);
            typing_speed = 1;
            break;
        default:
            current_dialogue = "";
        ...
        while (typing_timer >= 1)
        {
            ...
            if (letter_index < string_length(current_dialogue))
            {
                ...
                else
                {
                    ...
                    else if (next_char != " " && next_char != "*" && next_char != "?" && next_char != "(" && displayed_text != "*" && next_char != ")" && next_char != "!")
                    {
                        if (susietalk)
