...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_0"), 32);
            typing_speed = 0.5;
            break;
        case 2:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_1"), 32);
            typing_speed = 0.5;
        ...
        case 3:
            foanetalk = false;
            feighlinetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_2"), 32);
            typing_speed = 0.5;
            foanegain = 1.5;
            break;
        case 4:
            foanetalk = false;
            feighlinetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_3"), 32);
            typing_speed = 0.5;
            foanegain = 1.5;
            break;
        case 5:
            foanetalk = true;
            feighlinetalk = false;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_4"), 32);
            typing_speed = 0.5;
            break;
        case 6:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_5"), 32);
            typing_speed = 0.5;
            break;
        case 7:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_6"), 32);
            typing_speed = 0.5;
            break;
        case 8:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_7"), 32);
            typing_speed = 0.5;
            break;
        case 9:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_8"), 32);
            typing_speed = 0.5;
            break;
        case 10:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_9"), 32);
            typing_speed = 0.6;
            break;
        case 11:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_10"), 32);
            typing_speed = 0.7;
            break;
        case 12:
            foanetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_11"), 32);
            typing_speed = 0.8;
            break;
        case 13:
            foanetalk = false;
            feighlinetalk = true;
            current_dialogue = format_text(translation_get_string("obj_foanetv_2_Draw_73_12"), 32);
            typing_speed = 1;
        ...
        if (text_complete)
        {
            ...
            if (array_contains(endcase, dialogue))
            {
                ...
                if (dialogue == 2)
                {
                    ...
                    window_set_caption(translation_get_string("obj_foanetv_2_Draw_73_13"));
                    d2trigger = true;
                }
