...
if (displayblack)
{
    ...
    percent1 += (1/3);
    draw_sprite_ext(sBlackScreen, 0, 320, 240, 2, 2, 0, c_white, 1);
    ...
    if (percent1 == 1)
    {
        ...
        if (!global.c3maximikecompleted)
        {
            ...
            obj_memorandum_notice_c3.image_index = 6;
            global.c3maximikecompleted = true;
        }
...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            ...
            current_dialogue = format_text(get_lang_string("gml_Object_obj_falsefountainend_text_Draw_73_0"), 25);
            dialogueicon = 34;
            typing_speed = 1;
            break;
        case 2:
            ...
            ralseitalk = false;
            dialogueiconchoice = sSusieDialogueSprite;
            current_dialogue = format_text(get_lang_string("gml_Object_obj_falsefountainend_text_Draw_73_1"), 25);
            dialogueicon = 28;
            typing_speed = 1;
            break;
        default:
