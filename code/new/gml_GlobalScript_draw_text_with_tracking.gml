function draw_text_with_tracking(arg0, arg1, arg2, arg3, arg4, arg5)
{
    ...
    var current_y = arg1;
    draw_set_color(arg3);
    var line_height = string_height(translation_get_string("gml_GlobalScript_draw_text_with_tracking_0"));
    
    for (var i = 1; i <= string_length(arg2); i++)
    {
        var char = string_char_at(arg2, i);
        
        if (char == translation_get_string("gml_GlobalScript_draw_text_with_tracking_1"))
        {
            current_x = arg0;
