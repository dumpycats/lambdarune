...
if (talking)
{
    ...
    switch (dialogue)
    {
        case 1:
            texttalk = true;
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_0");
            typing_speed = 1;
            break;
        case 2:
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_1");
            typing_speed = 1;
            break;
        case 3:
            texttalk = true;
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_2");
            typing_speed = 1;
            break;
        case 4:
            texttalk = true;
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_3");
            typing_speed = 1;
            break;
        case 5:
            texttalk = true;
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_4");
            typing_speed = 1;
            break;
        case 6:
            texttalk = true;
            current_dialogue = get_lang_string("gml_Object_obj_angrytunes_Draw_73_5");
            typing_speed = 1;
            break;
        case 7:
            texttalk = true;
